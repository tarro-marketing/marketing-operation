...
write_csv(final_campaign_sfdc_lead, "clean_data/final_campaign_sfdc_lead.csv")
...
write_csv(duplicate_ids_contact, "clean_data/duplicate_ids_contact.csv")
...
inboundcall <- inboundcall |> 
  ...
  mutate(Campaign_by_Month = case_when(
