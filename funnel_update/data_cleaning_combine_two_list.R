...
write_csv(final_campaign_sfdc_lead, "funnel_update/clean-data/final_campaign_sfdc_lead.csv")
...
write_csv(duplicate_ids_contact, "funnel_update/clean-data/duplicate_ids_contact.csv")
