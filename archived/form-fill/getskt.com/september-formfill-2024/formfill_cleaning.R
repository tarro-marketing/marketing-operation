...
folder_path <- here("form-fill", "september-formfill-2024")
...
combo_data2 |>
  filter(str_detect(Referrer,"(?i)directmail"))-> direct_mail

sheet_write(combo_data2, ss = "18y8li4QmbStR-6XFc-Vx8o9qzTDJrGIExAObVzG8RpE", sheet = "9/1 - 10/7 Formfill")
