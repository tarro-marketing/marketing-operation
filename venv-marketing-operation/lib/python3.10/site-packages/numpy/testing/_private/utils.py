...
from numpy._core import (arange, array, array_repr, empty, float32, intp,
                         isnat, ndarray)
...
def assert_equal(actual, desired, err_msg='', verbose=True, *, strict=False):
    ...
    if isinstance(desired, dict):
        ...
        return
    if isinstance(
            desired, (list, tuple)) and isinstance(
            actual, (list, tuple)):
        assert_equal(len(actual), len(desired), err_msg, verbose)
...
def assert_array_compare(comparison, x, y, err_msg='', verbose=True, header='',
    ...
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy._core import (all, array2string, errstate, inf, isnan, max,
                             object_)
...
def _assert_no_gc_cycles_context(name=None):
    ...
    try:
        ...
        # were found -- we are checking that no cycles were created in the
        # context
    ...
    def decorator(func):
        ...
        def wrapper(*a, **kw):
            ...
            try:
                ...
                # Probably ran out of memory regardless: don't regard as
                # failure
