...
I_bool_high_open: np.ndarray[Any, np.dtype[np.bool]] = np.array([
                                                                1], dtype=np.bool)
I_bool_high_closed: np.ndarray[Any, np.dtype[np.bool]] = np.array([
                                                                  1], dtype=np.bool)
...
I_u1_high_closed: np.ndarray[Any, np.dtype[np.uint8]] = np.array(
    [255], dtype=np.uint8)
...
def_gen.integers(-9223372036854775808, 9223372036854775807,
                 dtype="i8", endpoint=True)
...
def_gen.integers(-9223372036854775808, I_i8_high_closed,
                 dtype="i8", endpoint=True)
...
def_gen.choice(["pooh", "rabbit", "piglet", "Christopher"], 3,
               replace=False, p=np.array([1 / 8, 1 / 8, 1 / 2, 1 / 4]))
...
random_st.choice(["pooh", "rabbit", "piglet", "Christopher"],
                 3, replace=False, p=np.array([1 / 8, 1 / 8, 1 / 2, 1 / 4]))
