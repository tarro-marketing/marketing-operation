...
from numpy._core.multiarray import _monotonicity, _place, bincount
...
from numpy._core.numeric import (absolute, arange, array, asanyarray, asarray,
                                 concatenate, dot, empty, integer, intp,
                                 isscalar, ndarray, ones, take, where,
                                 zeros_like)
from numpy._core.numerictypes import typecodes
from numpy._core.umath import (add, arctan2, cos, exp, frompyfunc, less_equal,
                               minimum, mod, not_equal, pi, sin, sqrt,
                               subtract)
...
def blackman(M):
    ...
    n = arange(1 - M, M, 2)
    return 0.42 + 0.5 * cos(pi * n / (M - 1)) + 0.08 * \
        cos(2.0 * pi * n / (M - 1))
