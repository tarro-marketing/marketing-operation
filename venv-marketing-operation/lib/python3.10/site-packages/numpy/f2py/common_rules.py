...
"""
from . import __version__, capi_maps, func2subr
from .auxfuncs import (getuseblocks, hasbody, hascommon, hasnote,
                       isintent_hide, outmess)
...
def buildhooks(m):
    ...
    for (name, vnames, vars) in findcommonblocks(m):
        ...
        cadd('}\n')
        iadd(
            '\ttmp = PyFortranObject_New(f2py_%s_def,f2py_init_%s);' %
            (name, name))
