...
def scaninputline(inputline):
    ...
    if signsfile and os.path.isfile(
            signsfile) and 'h-overwrite' not in options:
        errmess(
...
def run_compile():
    ...
    # TODO: Once distutils is dropped completely, i.e. min_ver >= 3.12, unify
    # into --fflags
    ...
    sys.argv = [
        _m for _m in sys.argv if _m not in (
            fc_flags +
            distutils_flags)]
