...
class TestTimeScalars:
    ...
    @pytest.mark.parametrize(
        "scalar", [
            param(
                np.timedelta64(
                    "NaT", "s"), id="timedelta64[s](NaT)"), param(
                np.timedelta64(
                    123, "s"), id="timedelta64[s]"), param(
                np.datetime64(
                    "NaT", "generic"), id="datetime64[generic](NaT)"), param(
                np.datetime64(
                    1, "D"), id="datetime64[D]")],)
    ...
    @pytest.mark.parametrize(
        "scalar", [
            param(
                np.timedelta64(
                    123, "ns"), id="timedelta64[ns]"), param(
                np.timedelta64(
                    12, "generic"), id="timedelta64[generic]")])
