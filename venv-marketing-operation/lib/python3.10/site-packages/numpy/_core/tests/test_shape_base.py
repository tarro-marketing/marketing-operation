import numpy as np
import pytest
from numpy._core import (arange, array, atleast_1d, atleast_2d, atleast_3d,
                         block, concatenate, hstack, newaxis, stack, vstack)
from numpy._core.shape_base import (_block_concatenate, _block_dispatcher,
...
class TestBlock:
    ...
    def block(self, request):
        ...
        if request.param == 'force_concatenate':
            ...
            raise ValueError(
                'Unknown blocking request. There is a typo in the tests.')
