...
from numpy._core import sctypes, umath
from numpy._core._rational_tests import rational
from numpy._core.arrayprint import set_string_function
from numpy._core.numerictypes import obj2sctype
from numpy.exceptions import AxisError
from numpy.random import rand, randint, randn
from numpy.testing import (HAS_REFCOUNT, IS_WASM, assert_, assert_almost_equal,
...
class TestNonzero:
    ...
    def test_nonzero_onedim(self):
        ...
        #              dtype=[('a', 'i4'), ('b', 'i2')])
        x = np.array([(1, 2, -5, -3), (0, 0, 2, 7), (1, 1, 0, 1), (-1, 3, 1, 0),
                     (0, 7, 0, 4)], dtype=[('a', 'i4'), ('b', 'i2'), ('c', 'i1'), ('d', 'i8')])
    ...
    def test_nonzero_twodim(self):
        ...
        x = np.array([[(0, 1), (0, 0), (1, 11)], [(1, 1), (1, 0), (0, 0)], [
    ...
    def test_sparse(self):
        ...
        for i in range(20):
            ...
            c[10 + i:20 + i] = True
            c[20 + i * 2] = True
            assert_equal(np.nonzero(c)[0], np.concatenate(
                (np.arange(10 + i, 20 + i), [20 + i * 2])))
...
class TestArrayComparisons:
    ...
    def test_none_compares_elementwise(self):
        ...
        assert_equal(a is None, [True, False, True])
        assert_equal(a is not None, [False, True, False])

        a = np.ones(3)
        assert_equal(a is None, [False, False, False])
        assert_equal(a is not None, [True, True, True])
...
class TestClip:
    ...
    def test_type_cast_10(self):
        # Test native int32 with float min/max and float out for output
        # argument.
        a = self._generate_int_data(self.nr, self.nc)
...
class TestCreationFuncs:
    ...
    def setup_method(self):
        ...
        def keyfunc(dtype): return dtype.str
