...
from numpy.testing import (HAS_REFCOUNT, IS_PYPY, IS_PYSTON, IS_WASM,
...
class TestRegression:
    ...
    def test_pickle_py2_bytes_encoding(self):
        ...
        for original, data in test_data:
            ...
            if isinstance(
                    result,
                    np.ndarray) and result.dtype.names is not None:
    ...
    @pytest.mark.skipif(sys.maxsize < 2 ** 31 +
                        1, reason='overflows 32-bit python')
