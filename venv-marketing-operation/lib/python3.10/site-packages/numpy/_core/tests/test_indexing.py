...
class TestIndexing:
    ...
    def test_structured_advanced_indexing(self):
        ...
        # for structured datatypes, see gh-15387. This test can behave
        # randomly.
...
class TestBroadcastedAssignments:
    ...
    def test_prepend_not_one(self):
        ...
        assert_raises(ValueError, assign, a, s_[
                      [[1], [2]],], np.ones((2, 2, 1)))
    ...
    def _get_multi_index(self, arr, indices):
        ...
        for ax, indx in enumerate(in_indices):
            ...
            if isinstance(indx, np.ndarray) and indx.dtype == bool:
                ...
                try:
                    flat_indx = np.ravel_multi_index(np.nonzero(
                        indx), arr.shape[ax:ax + indx.ndim], mode='raise')
                except Exception:
...
class TestBooleanIndexing:
    ...
    def test_boolean_indexing_fast_path(self):
        ...
        # This is the same as it used to be. The above two should work like
        # this.
