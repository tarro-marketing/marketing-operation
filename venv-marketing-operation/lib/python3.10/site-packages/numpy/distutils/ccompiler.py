...
def CCompiler_object_filenames(
        self,
        source_filenames,
        strip_dir=0,
        output_dir=''):
...
def CCompiler_compile(self, sources, output_dir=None, macros=None,
    ...
    if not sources:
        return []
    from numpy.distutils.fcompiler import (FORTRAN_COMMON_FIXED_EXTENSIONS,
                                           FCompiler, has_f90_header)
