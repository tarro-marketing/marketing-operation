...
def get_path_from_frame(frame, parent_path=None):
    ...
    try:
        ...
        # sys.modules['__main__'] might be something else, like
        # easy_install(1).
...
# See also
# https://web.archive.org/web/20100314204946/http://www.livinglogic.de/Python/ansistyle
...
class Configuration:
    ...
    def _get_configuration_from_setup_py(self, setup_py,
        ...
        try:
            ...
            if not hasattr(setup_module, 'configuration'):
                ...
                pn = dot_join(
                    *([parent_name] + subpackage_name.split('.')[:-1]))
                args = (pn,)
    ...
    def add_data_dir(self, data_path):
        ...
        if d is None:
            if os.path.isabs(data_path):
                return self.add_data_dir(
                    (os.path.basename(data_path), data_path))
    ...
    def _optimize_data_files(self):
        ...
        for p, files in self.data_files:
            ...
            for f in files:
                data_dict[p].add(f)
        self.data_files[:] = [(p, list(files))
                              for p, files in data_dict.items()]
    ...
    def add_installed_library(
        ...
        self.installed_libraries.append(
            InstallableLib(name, build_info, install_dir))
    ...
    def get_info(self, *names):
        ...
        """
        from .system_info import dict_append, get_info
        info_dict = {}
        for a in names:
