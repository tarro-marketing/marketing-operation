...
def find_dll(dll_name):
    ...
    def _find_dll_in_winsxs(dll_name):
        ...
        winsxs_path = os.path.join(
            os.environ.get("WINDIR", r"C:\WINDOWS"), "winsxs"
        )
...
def build_msvcr_library(debug=False):
    ...
    if msvcr_ver < 80:
        log.debug(
            "Skip building msvcr library:" " custom functionality not present"
        )
        return False
