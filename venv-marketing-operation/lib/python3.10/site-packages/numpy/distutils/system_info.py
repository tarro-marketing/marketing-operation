    ...
    with open(os.devnull, 'w') as tmp:
        try:
            p = subprocess.Popen(["gcc", "-print-multiarch"],
                                 stdout=subprocess.PIPE, stderr=tmp)
...
class system_info:
    ...
    def __init__(self,
        ...
        defaults = {
            ...
            'search_static_first': str(
                self.search_static_first),
            'extra_compile_args': '',
            'extra_link_args': ''}
        ...
        for lib in libs:
            ...
            if r_dirs:
                ...
                if i is not None:
                    ...
                    log.info(
                        'Runtime library %s was not found. Ignoring' %
                        (lib))
...
class lapack_opt_info(system_info):
    ...
    def _get_info_lapack(self):
        ...
        if not info:
            ...
            if not info_src:
                warnings.warn(
                    LapackSrcNotFoundError.__doc__ or '',
                    stacklevel=3)
                return {}
...
class blas_opt_info(system_info):
    ...
    def calc_info(self):
        ...
        if len(unknown_order) > 0:
            raise ValueError(
                "blas_opt_info user defined BLAS order has unacceptable values: {}".format(unknown_order))
...
class blas_info(system_info):
    ...
    def calc_info(self):
        ...
        if platform.system() == 'Windows':
            ...
            cblas_opt = cblas_info_obj.get_option_single(
                'cblas_libs', 'libraries')
...
class openblas_info(blas_info):
    ...
    def _calc_info(self):
        ...
        if self.symbol_prefix:
            info['define_macros'] += [('BLAS_SYMBOL_PREFIX',
                                       self.symbol_prefix)]
        if self.symbol_suffix:
            info['define_macros'] += [('BLAS_SYMBOL_SUFFIX',
                                       self.symbol_suffix)]
