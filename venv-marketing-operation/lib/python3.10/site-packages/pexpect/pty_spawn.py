...
class spawn(SpawnBase):
    ...
    def _spawn(self, command, args=[], preexec_fn=None, dimensions=None):
        ...
        self.ptyproc = self._spawnpty(
            self.args, env=self.env, cwd=self.cwd, **kwargs
        )
    ...
    def read_nonblocking(self, size=1, timeout=-1):
        ...
        if self.use_poll:
            ...
            def select(timeout):
                return select_ignore_interrupts(
    ...
    def interact(
        self, escape_character=chr(29), input_filter=None, output_filter=None
    ):
