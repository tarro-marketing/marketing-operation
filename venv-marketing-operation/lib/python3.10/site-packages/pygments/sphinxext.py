...
class PygmentsDoc(Directive):
    ...
    def document_lexers_overview(self):
        ...
        for classname, data in sorted(
            LEXERS.items(), key=lambda x: x[1][1].lower()
        ):
        ...
        out.append(
            write_row("Name", "Extension(s)", "Short name(s)", "Lexer class")
        )
        out.append(write_seperator())
        for row in table:
            out.append(
    ...
    def document_lexers(self):
        ...
        for module, lexers in sorted(modules.items(), key=lambda x: x[0]):
            ...
            heading = (
                moduledocstrings[module].splitlines()[4].strip().rstrip(".")
            )
