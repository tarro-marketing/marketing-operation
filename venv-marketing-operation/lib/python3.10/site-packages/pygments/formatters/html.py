...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def __init__(self, **options):
        ...
        self.noclobber_cssfile = get_bool_opt(
            options, "noclobber_cssfile", False
        )
        ...
        self.debug_token_types = get_bool_opt(
            options, "debug_token_types", False
        )
    ...
    def _wrap_full(self, inner, outfile):
        if self.cssfile:
            if os.path.isabs(self.cssfile):
                ...
                try:
                    ...
                    cssfilename = os.path.join(
                        os.path.dirname(filename), self.cssfile
                    )
            ...
            try:
                if (
                    not os.path.exists(cssfilename)
                    or not self.noclobber_cssfile
                ):
        ...
        for ttype, value in tokensource:
            ...
            for part in parts[:-1]:
                if line:
                    ...
                    yield 1, "".join(
                        (cspan, part, (cspan and "</span>"), lsep)
                    )
                else:
                    yield 1, lsep
            # for the last line
