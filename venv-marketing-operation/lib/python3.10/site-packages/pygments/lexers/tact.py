    ...
    tokens = {
        ...
        "struct-header": [
            ...
            (
                ...
                bygroups(Punctuation, Number.Hex, Punctuation),
            ),
            (
                r"(\()((?:\b[0-9]+\b))(\))",
                bygroups(Punctuation, Number.Integer, Punctuation),
            ),
        ],
        "struct-body-in": [
        ...
        "fun-arguments": [
            ...
            (
                r"(self)|(\b[\w]+\b)",
                bygroups(Name.Variable.Instance, Name.Variable),
            ),
            (r",", Punctuation),
            (r"\s+", Whitespace),
        ],
        ...
        "annotation-in": [
            (
                r"(@)(\w+)(\()",
                bygroups(Keyword.Pseudo, Keyword, Punctuation),
                "annotation",
            )
        ],
        "annotation": [
