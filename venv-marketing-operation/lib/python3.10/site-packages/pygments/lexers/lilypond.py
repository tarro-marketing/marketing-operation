...
class LilyPondLexer(SchemeLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(pitches, suffix=r"=?[',]*!?\??" + NAME_END_RE),
                Token.Pitch,
            ),
            ...
            (
                builtin_words(repeat_types, "disallowed"),
                Token.Name.Builtin.RepeatType,
            ),
            (builtin_words(units, "mandatory"), Token.Number),
            (
                builtin_words(chord_modifiers, "disallowed"),
                Token.ChordModifier,
            ),
            (
            ...
            (
                builtin_words(translators, "disallowed"),
                Token.Name.Builtin.Translator,
            ),
