...
def _luau_make_expression(should_pop, _s):
    temp_list = [
        ...
        (
            words(("true", "false", "nil"), suffix=r"\b"),
            Keyword.Constant,
            "#pop",
        ),
        (r"\[(=*)\[[.\n]*?\]\1\]", String, "#pop"),
...
class LuauLexer(RegexLexer):
    ...
    tokens = {
        ...
        "type": [
            ...
            (
                r"typeof\(",
                Name.Builtin,
                ("closing_parenthesis_base", "expression"),
            ),
    ...
    def __init__(self, **options):
        ...
        self.additional_builtins = get_list_opt(
            options, "additional_builtins", []
        )
...
class LSLLexer(RegexLexer):
    ...
    lsl_types = (
        r"\b(?:float|integer|key|list|quaternion|rotation|string|vector)\b"
    )
    ...
    lsl_constants_float = (
        r"\b(?:DEG_TO_RAD|PI(?:_BY_TWO)?|RAD_TO_DEG|SQRT2|TWO_PI)\b"
    )
    ...
    lsl_constants_vector = (
        r"\b(?:TOUCH_INVALID_(?:TEXCOORD|VECTOR)|ZERO_VECTOR)\b"
    )
...
class EasytrieveLexer(RegexLexer):
    ...
    def analyse_text(text):
        ...
        def isCommentLine(line):
            return (
                EasytrieveLexer._COMMENT_LINE_REGEX.match(lines[0]) is not None
            )
