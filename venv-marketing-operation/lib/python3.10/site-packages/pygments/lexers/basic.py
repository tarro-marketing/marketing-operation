    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(
                    Operator, Whitespace, Punctuation, Whitespace, Name.Class
                ),
            ),
            (
                rf"\b{bb_var}\b([ \t]*)(\()",
    ...
    tokens = {
        "root": [
            ...
            (
                r"(DIM)(\s+)([^\s(]+)",
                bygroups(
                    Keyword.Declaration, Text.Whitespace, Name.Variable.Global
                ),
            ),
            (
                r"^(\s*)([a-zA-Z_]+)(\s*)(\=)",
        ...
        "metacommands": [
            (
                r"\b({})(?=\(|\b)".format(
                    "|".join(map(re.escape, metacommands))
                ),
                Keyword.Constant,
            ),
        ],
        "operators": [
            (
                r"\b({})(?=\(|\b)".format("|".join(map(re.escape, operators))),
                Operator.Word,
            ),
        ],
        "statements": [
...
class VBScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(_vbscript_builtins.OPERATOR_WORDS, suffix=r"\b"),
                Operator.Word,
            ),
            (
                words(_vbscript_builtins.BUILTIN_CONSTANTS, suffix=r"\b"),
                Name.Constant,
            ),
            (
                words(_vbscript_builtins.BUILTIN_FUNCTIONS, suffix=r"\b"),
                Name.Builtin,
            ),
            (
                words(_vbscript_builtins.BUILTIN_VARIABLES, suffix=r"\b"),
                Name.Builtin,
            ),
            (r"[a-z_][a-z0-9_]*", Name),
            (r"\b_\n", Operator),
