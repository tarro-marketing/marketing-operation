...
class Inform6Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "_expression": [
            ...
            (r"(?=sp\b)", Text, "#pop"),
            (
                rf"(?=[{_dquote}{_squote}$0-9#a-zA-Z_])",
                Text,
                ("#pop", "value"),
            ),
        ...
        "value": [
            ...
            (
                rf"(#g\$)({_name})",
                bygroups(Operator, Name.Variable.Global),
                "#pop",
            ),
...
class Tads3Lexer(RegexLexer):
    ...
    def _make_attribute_value_state(
        ...
        token = (
            String.Double
            if terminator == r'"'
            else String.Single if terminator == r"'" else String.Other
        )
    ...
    tokens = {
        ...
        "main/basic": [
            ...
            (
                r"(modify|replace|switch|throw|transient)\b",
                Keyword.Reserved,
                "#pop",
            ),
