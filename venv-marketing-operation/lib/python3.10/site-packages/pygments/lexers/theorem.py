...
class IsabelleLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(keyword_section, prefix=r"\b", suffix=r"\b"),
                Generic.Heading,
            ),
            (
                words(keyword_subsection, prefix=r"\b", suffix=r"\b"),
                Generic.Subheading,
            ),
            (
                words(keyword_theory_goal, prefix=r"\b", suffix=r"\b"),
                Keyword.Namespace,
            ),
            (
            ...
            (
                words(keyword_abandon_proof, prefix=r"\b", suffix=r"\b"),
                Generic.Error,
            ),
            ...
            (
                words(keyword_proof_asm_goal, prefix=r"\b", suffix=r"\b"),
                Keyword,
            ),
            (
                words(keyword_proof_script, prefix=r"\b", suffix=r"\b"),
                Keyword.Pseudo,
            ),
            (r"\\<(\w|\^)*>", Text.Symbol),
            (r"'[^\W\d][.\w']*", Name.Type),
