    ...
    tokens = {
        ...
        "instruction-args": [
            ...
            (
                "([a-z0-9]+)( )(<)(" + identifier + ")(>)",
                bygroups(
                    Number.Hex, Text, Punctuation, Name.Constant, Punctuation
                ),
            ),
            (
                "([a-z0-9]+)( )(<)("
...
class HsailLexer(RegexLexer):
    ...
    ieeefloat = (
        r"0((h|H)[0-9a-fA-F]{4}|(f|F)[0-9a-fA-F]{8}|(d|D)[0-9a-fA-F]{16})"
    )
...
class LlvmMirBodyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Basic Block Labels
            (
                r"bb\.[0-9]+(\.[a-zA-Z0-9_.-]+)?( \(address-taken\))?:",
                Name.Label,
            ),
            (
                r"bb\.[0-9]+ \(%[a-zA-Z0-9_.-]+\)( \(address-taken\))?:",
...
class Dasm16Lexer(RegexLexer):
    ...
    def guess_identifier(lexer, match):
        ident = match.group(0)
        klass = (
            Name.Variable if ident.upper() in lexer.REGISTERS else Name.Label
        )
