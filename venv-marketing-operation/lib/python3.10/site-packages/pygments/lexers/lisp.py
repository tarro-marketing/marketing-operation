...
class RacketLexer(RegexLexer):
    ...
    _inexact_simple = (
        rf"(?:{_inexact_simple_no_hashes}|(?:\d+#+(?:\.#*|/\d+#*)?|\.\d+#+|"
        r"\d+(?:\.\d*#+|/\d+#+)))"
    )
    ...
    tokens = {
        ...
        "datum": [
            ...
            (
                rf"(?i)(([-+]?{_inexact_simple}t[-+]?\d+)|[-+](inf|nan)\.t)(?=[{_delimiters}])",
                Number.Float,
                "#pop",
            ),
            # #b
        ...
        "quasiquoted-datum": [
            ...
            (
                rf"unquote(-splicing)?(?=[{_delimiters}])",
                Keyword,
                ("#pop", "unquoted-datum"),
            ),
