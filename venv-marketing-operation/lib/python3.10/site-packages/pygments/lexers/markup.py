    ...
    tokens = {
        "root": [
            ...
            (
                r"^(=+)([^=]+)(=+)(\s*#.+)?$",
                bygroups(
                    Generic.Heading, using(this), Generic.Heading, String
                ),
            ),
            # Literal code blocks, with optional shebang
            (
                r"(\{\{\{)(\n#!.+)?",
                bygroups(Name.Builtin, Name.Namespace),
                "codeblock",
            ),
    ...
    tokens = {
        "root": [
            ...
            (
                r"^( *\.\.)(\s*)(_(?:[^:\\]|\\.)+:)(.*?)$",
                bygroups(
                    Punctuation, Text, Name.Tag, using(this, state="inline")
                ),
            ),
            ...
            (
                r"^(\S.*(?<!::)\n)((?:(?: +.*)\n)+)",
                bygroups(
                    using(this, state="inline"), using(this, state="inline")
                ),
            ),
            # Code blocks
            (
...
class MarkdownLexer(RegexLexer):
    ...
    def _handle_codeblock(self, match):
        ...
        if match.group("afterlang") is not None:
            yield match.start("whitespace"), Whitespace, match.group(
                "whitespace"
            )
        ...
        yield match.start("terminator"), String.Backtick, match.group(
            "terminator"
        )
    ...
    tokens = {
        "root": [
            ...
            (
                r"^(\s*)([*-] )(\[[ xX]\])( .+\n)",
                bygroups(
                    Whitespace, Keyword, Keyword, using(this, state="inline")
                ),
            ),
            # bulleted list
            (
    ...
    tokens = {
        "root": [
            ...
            (
                r"^(\*\*+ )(COMMENT)( .*)",
                bygroups(
                    Generic.Subheading, Comment.Preproc, Generic.Subheading
                ),
            ),
            (
                r"^(\* )(DONE)( .*)",
            ...
            (
                r"^(\*\*+ )(DONE)( .*)",
                bygroups(
                    Generic.Subheading, Generic.Deleted, Generic.Subheading
                ),
            ),
            (
                r"^(\* )(TODO)( .*)",
            ...
            (
                r"^(\*\*+ )(TODO)( .*)",
                bygroups(
                    Generic.Subheading, Generic.Error, Generic.Subheading
                ),
            ),
            (
                r"^(\* .+?)( :[a-zA-Z0-9_@:]+:)?$",
                bygroups(Generic.Heading, Generic.Emph),
            ),
            (
                r"^(\*\*+ .+?)( :[a-zA-Z0-9_@:]+:)?$",
                bygroups(Generic.Subheading, Generic.Emph),
            ),
            ...
            (
                r"^( *)([0-9]+[.)])( \[@[0-9]+\])?",
                bygroups(Whitespace, Keyword, Generic.Emph),
            ),
            # Dynamic blocks
            (
                r"(?i)^( *#\+begin: *)((?:.|\n)*?)(^ *#\+end: *$)",
            ...
            (
                r"(?i)^( *#\+begin_\w+)( *\n)((?:.|\n)*?)(^ *#\+end_\w+)( *$)",
                bygroups(
                    Operator.Word, Whitespace, Text, Operator.Word, Whitespace
                ),
            ),
            # Keywords
...
class WikitextLexer(RegexLexer):
    ...
    tokens = {
        ...
        "inline": [
            ...
            (
                r"('')(''')(?!')",
                bygroups(Generic.Emph, Generic.EmphStrong),
                "inline-italic-bold",
            ),
        ...
        "inline-bold-italic": [
            ...
            (
                r"('')(''')(?!')",
                bygroups(Generic.EmphStrong, Generic.Strong),
                "#pop",
            ),
        ...
        "inline-italic-bold": [
            ...
            (
                r"(''')('')(?!')",
                bygroups(Generic.EmphStrong, Generic.Emph),
                "#pop",
            ),
            (r"'''(?!')", Generic.EmphStrong, ("#pop", "inline-italic")),
            (r"''(?!')", Generic.EmphStrong, ("#pop", "inline-bold")),
        ...
        "replaceable": [
            ...
            (
                r"(?i)(<)(tvar)\b(\|)([^>]*?)(>)",
                bygroups(
                    Punctuation, Name.Tag, Punctuation, String, Punctuation
                ),
            ),
            (r"</>", Punctuation, "#pop"),
            # <tvar>
