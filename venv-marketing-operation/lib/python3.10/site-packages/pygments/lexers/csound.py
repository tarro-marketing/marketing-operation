...
class CsoundOrchestraLexer(CsoundLexer):
    ...
    def name_callback(lexer, match):
        ...
        if (
            name in OPCODES
            or name in DEPRECATED_OPCODES
            or name in REMOVED_OPCODES
        ):
    ...
    tokens = {
        ...
        "partial statements": [
            ...
            (
                words(("return", "rireturn"), prefix=r"\b", suffix=r"\b"),
                Keyword.Pseudo,
            ),
