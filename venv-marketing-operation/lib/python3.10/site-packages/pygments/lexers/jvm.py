...
class GoloLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?<=[^-])(-)(?=[^-])", Operator),
            (
                r"(?<=[^`])(is|isnt|and|or|not|oftype|in|orIfNull)\b",
                Operator.Word,
            ),
            (r"[]{}|(),[]", Punctuation),
            (
...
class JasminLexer(RegexLexer):
    ...
    tokens = {
        "default": [
            ...
            (
                r"-?(\d+\.\d*|\.\d+)([eE][-+]?\d+)?[fFdD]?"
                rf"[\x00-\x08\x0b\x0c\x0e-\x1f]*{_break}",
                Number.Float,
            ),
            ...
            (
                ...
                rf"static|virtual){_break}",
                Keyword.Reserved,
                "invocation",
            ),
            (
                rf"(getfield|putfield){_break}",
                Keyword.Reserved,
                ("descriptor/no-dots", "field"),
            ),
            (
                rf"(getstatic|putstatic){_break}",
                Keyword.Reserved,
            ...
            (
                rf"(multianewarray|newarray){_break}",
                Keyword.Reserved,
        ...
        "verification": [
            include("default"),
            (
                rf"(Double|Float|Integer|Long|Null|Top|UninitializedThis){_break}",
                Keyword,
                "#pop",
            ),
