...
class YangLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                words(META_STMT_KEYWORDS, suffix=suffix_re_pattern),
                Token.Keyword,
            ),
            (
                words(LINKAGE_STMTS_KEYWORDS, suffix=suffix_re_pattern),
                Token.Keyword,
            ),
            (
                words(BODY_STMT_KEYWORDS, suffix=suffix_re_pattern),
                Token.Keyword,
            ),
            (
                words(DATA_DEF_STMT_KEYWORDS, suffix=suffix_re_pattern),
                Token.Keyword,
            ),
            (
                words(TYPE_STMT_KEYWORDS, suffix=suffix_re_pattern),
                Token.Keyword,
            ),
            (
                words(LIST_STMT_KEYWORDS, suffix=suffix_re_pattern),
                Token.Keyword,
            ),
