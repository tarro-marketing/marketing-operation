...
class InteractiveShellTestCase(unittest.TestCase):
    ...
    def test_bad_custom_tb_return(self):
        ...
        ip.set_custom_exc(
            (NameError,), lambda etype, value, tb, tb_offset=None: 1
        )
    ...
    def test_var_expand(self):
        ...
        self.assertEqual(
            ip.var_expand("grep x | awk '{print $1}'"),
            "grep x | awk '{print $1}'",
        )
    ...
    def test_showtraceback_with_surrogates(self, mocked_print):
        ...
        interactiveshell.InteractiveShell._showtraceback(
            ip, None, None, chr(0xD8FF)
        )
    ...
    def test_last_execution_result(self):
        ...
        self.assertIsInstance(
            ip.last_execution_result.error_in_exec, NameError
        )
...
class TestShowTracebackAttack(unittest.TestCase):
    ...
    def test_set_show_tracebacks_noop(self):
        ...
        assert (
            str(result.error_in_exec) == "This should not raise an exception"
        )
