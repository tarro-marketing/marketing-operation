...
class BasicMagics(Magics):
    ...
    @magic_arguments.argument(
        "name", help="""Name of the magic to be created."""
    )
    @magic_arguments.argument(
...
Currently the magic system has the following functions:""",
    ...
    def pprint(self, parameter_s=""):
        ...
        print(
            "Pretty printing has been turned",
    ...
    @magic_arguments.magic_arguments()
    @magic_arguments.argument(
        "filename", type=str, help="Notebook name or filename"
    )
    @line_magic
    def notebook(self, s):
        ...
        for session, execution_count, source in hist[:-1]:
            cells.append(
                v4.new_code_cell(
                    execution_count=execution_count, source=source
                )
            )
...
class AsyncMagics(BasicMagics):
    ...
    def autoawait(self, parameter_s):
        ...
        if param in self.shell.loop_runner_map:
            self.shell.loop_runner, self.shell.autoawait = (
                self.shell.loop_runner_map[param]
            )
            return None
