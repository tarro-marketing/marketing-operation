...
class ProfileAwareConfigLoader(PyFileConfigLoader):
    ...
    def load_subconfig(self, fname, path=None, profile=None):
        ...
        return super(ProfileAwareConfigLoader, self).load_subconfig(
            fname, path=path
        )
...
class BaseIPythonApplication(Application):
    ...
    def load_config_file(self, suppress_errors=IPYTHON_SUPPRESS_CONFIG_ERRORS):
        ...
        self.log.debug(
            "Searching path %s for config files", self.config_file_paths
        )
        ...
        for config_file_name in self.config_files:
            ...
            try:
                Application.load_config_file(
                    self, config_file_name, path=self.config_file_paths
                )
            except ConfigFileNotFound:
    ...
    def stage_default_config_file(self):
        ...
        if self.overwrite or not config_file.exists():
            self.log.warning(
                "Generating default config file: %r", (config_file)
            )
