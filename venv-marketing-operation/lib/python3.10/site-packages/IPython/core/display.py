...
def _display_mimetype(mimetype, objs, raw=False, metadata=None):
    ...
    *objs : object
    ...
    display_functions.display(
        *objs, raw=raw, metadata=metadata, include=[mimetype]
    )
...
class HTML(TextDisplayObject):
    ...
    def __init__(self, data=None, url=None, filename=None, metadata=None):
        ...
        super(HTML, self).__init__(
            data=data, url=url, filename=filename, metadata=metadata
        )
...
class ProgressBar(DisplayObject):
    ...
    def update(self):
        display_functions.display(
            self, display_id=self._display_id, update=True
        )
...
class JSON(DisplayObject):
    ...
    def _check_data(self):
        if self.data is not None and not isinstance(self.data, (dict, list)):
            raise TypeError(
                "%s expects JSONable dict or list, not %r"
                % (self.__class__.__name__, self.data)
            )
...
class Video(DisplayObject):
    ...
    def _repr_html_(self):
      ...
      Your browser does not support the <code>video</code> element.
                ...
                url, self.html_attributes, width, height
            )
            return output
        ...
        if isinstance(video, str):
            ...
            b64_video = (
                b2a_base64(video, newline=False).decode("ascii").rstrip()
            )
 ...
 Your browser does not support the video tag.
            ...
            self.html_attributes, width, height, mimetype, b64_video
        )
        return output
