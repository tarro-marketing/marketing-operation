...
class NavigableAutoSuggestFromHistory(AutoSuggestFromHistory):
    ...
    def connect(self, pt_app: PromptSession):
        ...
        pt_app.default_buffer.on_text_insert.add_handler(
            self.reset_history_position
        )
        pt_app.default_buffer.on_cursor_position_changed.add_handler(
            self._dismiss
        )
