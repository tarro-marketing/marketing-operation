...
AUTO_MATCH_BINDINGS = [
    *[
        Binding(
            cmd,
            [key],
            "focused_insert & auto_match & followed_by_closing_paren_or_end",
        )
    ...
    *[
        ...
        Binding(
            cmd,
            [key],
            "focused_insert & auto_match & preceded_by_raw_str_prefix",
        )
    ...
    Binding(
        match.skip_over,
        ['"'],
        "focused_insert & auto_match & followed_by_double_quote",
    ),
    Binding(
        match.skip_over,
        ["'"],
        "focused_insert & auto_match & followed_by_single_quote",
    ),
    Binding(
        match.delete_pair,
        ["backspace"],
...
ALT_AND_COMOBO_CONTROL_BINDINGS = [
    Binding(
        cmd, list(keys), "vi_insert_mode & default_buffer_focused & ebivim"
    )
    for keys, cmd in {
        # Control Combos
...
KEY_BINDINGS = [
    ...
    Binding(
        dismiss_completion, ["c-g"], "default_buffer_focused & has_completions"
    ),
    ...
    Binding(
        newline_autoindent,
        ["c-o"],
        "default_buffer_focused & emacs_insert_mode",
    ),
    ...
    *AUTO_SUGGEST_BINDINGS,
    ...
    Binding(
        win_paste, ["c-v"], "default_buffer_focused & ~vi_mode & is_windows_os"
    ),
    *SIMPLE_CONTROL_BINDINGS,
    *ALT_AND_COMOBO_CONTROL_BINDINGS,
]
