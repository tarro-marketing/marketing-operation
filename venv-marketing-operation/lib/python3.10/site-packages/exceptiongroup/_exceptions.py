...
_BaseExceptionGroupSelf = TypeVar(
    "_BaseExceptionGroupSelf", bound="BaseExceptionGroup"
)
...
class BaseExceptionGroup(BaseException, Generic[_BaseExceptionT_co]):
    ...
    def subgroup(
        self,
        __condition: Callable[
            [_BaseExceptionT_co | _BaseExceptionGroupSelf], bool
        ],
    ...
    def __str__(self) -> str:
        ...
        return (
            f"{self.message} ({len(self._exceptions)} sub-exception{suffix})"
        )
...
class ExceptionGroup(BaseExceptionGroup[_ExceptionT_co], Exception):
    ...
    if TYPE_CHECKING:
        ...
        def subgroup(
            self,
            __condition: type[_ExceptionT] | tuple[type[_ExceptionT], ...],
        ) -> ExceptionGroup[_ExceptionT] | None: ...
        ...
        def subgroup(
            self,
            __condition: Callable[
                [_ExceptionT_co | _ExceptionGroupSelf], bool
            ],
