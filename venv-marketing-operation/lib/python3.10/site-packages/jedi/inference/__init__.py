...
from jedi.inference.syntax_tree import (
    infer_expr_stmt,
...
class InferenceState:
    ...
    def reset_recursion_limitations(self):
        ...
        self.execution_recursion_detector = (
            recursion.ExecutionRecursionDetector(self)
        )
        ...
        if def_ is not None:
            ...
            if type_ == "with_stmt":
                ...
                return context.py__getattribute__(
                    name.value, position=name.end_pos
                )
    ...
    def parse_and_get_code(
        ...
        **kwargs
        ...
        return (
            grammar.parse(code=code, path=path, file_io=file_io, **kwargs),
            code,
        )
