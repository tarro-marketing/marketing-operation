...
class AbstractTreeName(AbstractNameDefinition):
    ...
    def get_qualified_names(self, include_module_names=False):
        import_node = search_ancestor(
            self.tree_name, "import_name", "import_from"
        )
...
class _ActualTreeParamName(BaseTreeParamName):
    ...
    def infer(self):
        ...
        doc_params = docstrings.infer_param(
...
class ParamName(_ActualTreeParamName):
    ...
    def get_executed_param_name(self):
        ...
        params_names = get_executed_param_names(
            self.function_value, self.arguments
        )
