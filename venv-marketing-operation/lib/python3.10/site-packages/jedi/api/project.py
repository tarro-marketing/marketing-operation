...
class Project:
    ...
    def save(self):
        ...
        self._get_config_folder_path(self._path).mkdir(
    ...
    def _search_func(self, string, complete=False, all_scopes=False):
        ...
        for module_context in search_in_file_ios(
            inference_state, file_ios, name, complete=complete
        ):
            names = get_module_names(
                module_context.tree_node, all_scopes=all_scopes
            )
