...
class BaseName:
    ...
    def description(self):
        ...
        if (
            typ in ("function", "class", "module", "instance")
            or tree_name is None
        ):
            if typ == "function":
        ...
        definition = (
            tree_name.get_definition(include_setitem=True) or tree_name
        )
    ...
    def parent(self):
        ...
        if (
            ...
            context = (
                self._get_module_context().create_value(parent).as_context()
            )
        else:
    ...
    def _get_signatures(self, for_docstring=False):
        ...
        if (
            for_docstring
            and self._name.api_type == "statement"
