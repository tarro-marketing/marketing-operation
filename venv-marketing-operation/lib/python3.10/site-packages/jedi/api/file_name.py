...
def complete_file_name(
    ...
    is_in_os_path_join = sigs and all(
        s.full_name == "os.path.join" for s in sigs
    )
...
def _add_os_path_join(module_context, start_leaf, bracket_start):
    ...
    if start_leaf.type == "error_leaf":
        ...
        if index > 0:
            ...
            if (
                ...
                return check(
                    error_node.children[index + 1], arglist_nodes[::2]
                )
        return None
    ...
    if searched_node.type == "arglist":
        ...
        if trailer.type == "error_node":
            ...
            return check(
                trailer.children[trailer_index - 1], arglist_nodes[::2]
            )
