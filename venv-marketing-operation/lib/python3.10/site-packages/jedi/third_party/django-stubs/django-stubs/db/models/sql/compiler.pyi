...
class SQLCompiler:
    ...
    def pre_sql_setup(
        ...
        List[
            Tuple[
                Expression, Tuple[str, Union[List[Any], Tuple[str, str]]], None
            ]
        ],
    ...
    def get_group_by(
        self,
        select: List[
            Tuple[BaseExpression, Tuple[str, List[float]], Optional[str]]
        ],
        order_by: List[
            Tuple[Expression, Tuple[str, List[Union[int, str]], bool]]
        ],
    ) -> List[Tuple[str, List[float]]]: ...
    ...
    def get_select(
        ...
        List[
            Tuple[Expression, Tuple[str, List[Union[int, str]]], Optional[str]]
        ],
    ...
    def get_extra_select(
        ...
        select: List[
            Tuple[Expression, Tuple[str, List[float]], Optional[str]]
        ],
    ...
    def find_ordering_name(
        ...
        already_seen: Optional[
            Set[
                Tuple[Optional[Tuple[Tuple[str, str]]], Tuple[Tuple[str, str]]]
            ]
        ] = ...,
