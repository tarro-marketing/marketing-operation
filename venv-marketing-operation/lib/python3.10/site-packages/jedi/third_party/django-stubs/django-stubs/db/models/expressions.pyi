...
class Combinable:
    ...
    def __add__(
        self: _Self, other: Optional[Union[timedelta, Combinable, float, str]]
    ) -> _Self: ...
    def __sub__(
        self: _Self, other: Union[timedelta, Combinable, float]
    ) -> _Self: ...
    def __mul__(
        self: _Self, other: Union[timedelta, Combinable, float]
    ) -> _Self: ...
    ...
    def __itruediv__(
        self: _Self, other: Union[Combinable, float]
    ) -> _Self: ...
    ...
    def __radd__(
        self, other: Optional[Union[datetime, float, Combinable]]
    ) -> Combinable: ...
...
class SimpleCol(Expression):
    ...
    def __init__(
        self, target: Field, output_field: Optional[_OutputField] = ...
    ): ...
