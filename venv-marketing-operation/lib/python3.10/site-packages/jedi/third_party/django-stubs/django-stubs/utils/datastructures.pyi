...
class MultiValueDict(MutableMapping[_K, _V]):
    @overload
    def __init__(
        self, key_to_list_mapping: Mapping[_K, Optional[List[_V]]] = ...
    ) -> None: ...
    @overload
    def __init__(
        self, key_to_list_mapping: Iterable[Tuple[_K, List[_V]]] = ...
    ) -> None: ...
    def getlist(self, key: _K, default: Any = ...) -> List[_V]: ...
    def setlist(self, key: _K, list_: List[_V]) -> None: ...
    def setlistdefault(
        self, key: _K, default_list: Optional[List[_V]] = ...
    ) -> List[_V]: ...
...
class ImmutableList(Tuple[_V, ...]):
    warning: str = ...
    def __init__(
        self, *args: Any, warning: str = ..., **kwargs: Any
    ) -> None: ...
