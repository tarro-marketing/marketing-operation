...
DatedItems = Tuple[
    Optional[Sequence[datetime.date]], Sequence[object], Dict[str, Any]
]
...
class BaseDayArchiveView(
    YearMixin, MonthMixin, DayMixin, BaseDateListView
): ...
class DayArchiveView(
    MultipleObjectTemplateResponseMixin, BaseDayArchiveView
): ...
...
class DateDetailView(
    SingleObjectTemplateResponseMixin, BaseDateDetailView
): ...
