...
class BaseModelAdmin:
    ...
    def to_field_allowed(
        self, request: HttpRequest, to_field: str
    ) -> bool: ...
...
class ModelAdmin(BaseModelAdmin):
    ...
    def log_addition(
        self, request: HttpRequest, object: Model, message: Any
    ) -> LogEntry: ...
    def log_change(
        self, request: HttpRequest, object: Model, message: Any
    ) -> LogEntry: ...
    def log_deletion(
        self, request: HttpRequest, object: Model, object_repr: str
    ) -> LogEntry: ...
    ...
    def response_add(
        ...
        request: HttpRequest,
        obj: Model,
        post_url_continue: Optional[str] = ...,
    ) -> HttpResponse: ...
    def response_change(
...
class InlineModelAdmin(BaseModelAdmin):
    ...
    def media(self) -> Media: ...
    def get_extra(
        self, request: HttpRequest, obj: Optional[Model] = ..., **kwargs: Any
    ) -> int: ...
    def get_min_num(
        self, request: HttpRequest, obj: Optional[Model] = ..., **kwargs: Any
    ) -> Optional[int]: ...
