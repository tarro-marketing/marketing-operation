...
class URLValidator(RegexValidator):
    ...
    schemes: List[str] = ...
    def __init__(
        self, schemes: Optional[Collection[str]] = ..., **kwargs: Any
    ) -> None: ...
...
class BaseValidator:
    ...
    limit_value: Any = ...
    def __init__(
        self, limit_value: Any, message: Optional[_ErrorMessage] = ...
    ) -> None: ...
...
class ProhibitNullCharactersValidator:
    ...
    code: str = ...
    def __init__(
        self, message: Optional[_ErrorMessage] = ..., code: Optional[str] = ...
    ) -> None: ...
    def __call__(self, value: Any) -> None: ...
