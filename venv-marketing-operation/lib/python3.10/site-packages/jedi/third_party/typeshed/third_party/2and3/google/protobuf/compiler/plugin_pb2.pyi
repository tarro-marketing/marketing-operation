...
class CodeGeneratorRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    file_to_generate: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        typing___Text
    ] = ...
    ...
    def proto_file(
        ...
        google___protobuf___descriptor_pb2___FileDescriptorProto
    ]: ...
    @property
...
class CodeGeneratorResponse(google___protobuf___message___Message):
    ...
    class _Feature(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[
            CodeGeneratorResponse.FeatureValue
        ]
    ):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        FEATURE_NONE = typing___cast(CodeGeneratorResponse.FeatureValue, 0)
        FEATURE_PROTO3_OPTIONAL = typing___cast(
            CodeGeneratorResponse.FeatureValue, 1
        )
    ...
    class File(google___protobuf___message___Message):
        ...
        def __init__(
            ...
            *,
            ...
            generated_code_info: typing___Optional[
                google___protobuf___descriptor_pb2___GeneratedCodeInfo
            ] = None,
        ) -> None: ...
        def HasField(
    ...
    def file(
        ...
        type___CodeGeneratorResponse.File
    ]: ...
    def __init__(
        self,
        *,
        ...
        file: typing___Optional[
            typing___Iterable[type___CodeGeneratorResponse.File]
        ] = None,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions___Literal[
            "error", b"error", "supported_features", b"supported_features"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
