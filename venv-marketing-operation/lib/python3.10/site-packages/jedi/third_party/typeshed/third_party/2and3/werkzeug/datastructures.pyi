...
class TypeConversionDict(Dict[_K, _V]):
    ...
    @overload
    def get(
        self, key: _K, default: _D, type: Callable[[_V], _R]
    ) -> Union[_R, _D]: ...
...
class Headers(object):
    ...
    @overload
    def get(
        self, key: str, default: _D, type: None = ...
    ) -> Union[str, _D]: ...
    @overload
    def get(self, key: str, *, type: Callable[[str], _R]) -> Optional[_R]: ...
    @overload
    def get(
        self, key: str, default: _D, type: Callable[[str], _R]
    ) -> Union[_R, _D]: ...
    @overload
    ...
    @overload
    def get(
        self, key: str, *, type: Callable[[Any], _R], as_bytes: bool
    ) -> Optional[_R]: ...
    @overload
    def get(
        self, key: str, default: Any, type: None, as_bytes: bool
    ) -> Any: ...
    @overload
    def get(
        self, key: str, default: _D, type: Callable[[Any], _R], as_bytes: bool
    ) -> Union[_R, _D]: ...
    def getlist(
        self, key, type: Optional[Any] = ..., as_bytes: bool = ...
    ): ...
...
class CombinedMultiDict(ImmutableMultiDictMixin, MultiDict[_K, _V]):  # type: ignore
    ...
    def __getitem__(self, key): ...
    def get(
        self, key, default: Optional[Any] = ..., type: Optional[Any] = ...
    ): ...
    def getlist(self, key, type: Optional[Any] = ...): ...
    def keys(self): ...
    __iter__: Any
...
class Accept(ImmutableList[Tuple[str, float]]):
    provided: bool
    def __init__(
        self, values: Union[None, Accept, Iterable[Tuple[str, float]]] = ...
    ) -> None: ...
    @overload
    ...
    @overload
    def best_match(
        self, matches: Iterable[str], default: None = ...
    ) -> Optional[str]: ...
    @overload
    def best_match(
        self, matches: Iterable[str], default: _D
    ) -> Union[str, _D]: ...
    @property
...
class CallbackDict(UpdateDictMixin, Dict[_K, _V]):
    on_update: Any
    def __init__(
        self, initial: Optional[Any] = ..., on_update: Optional[Any] = ...
    ): ...

class HeaderSet(MutableSet[str]):
    on_update: Any
    def __init__(
        self, headers: Optional[Any] = ..., on_update: Optional[Any] = ...
    ): ...
    def add(self, header): ...
...
class ETags(Container[str], Iterable[str]):
    ...
    def __init__(
        self,
        strong_etags: Optional[Any] = ...,
        weak_etags: Optional[Any] = ...,
        star_tag: bool = ...,
    ): ...
...
class IfRange:
    ...
    date: Any
    def __init__(
        self, etag: Optional[Any] = ..., date: Optional[Any] = ...
    ): ...
    def to_header(self): ...
...
class Authorization(ImmutableDictMixin, Dict[str, Any]):  # type: ignore
    type: str
    def __init__(
        self, auth_type: str, data: Optional[Mapping[str, Any]] = ...
    ) -> None: ...
    @property
...
class FileStorage(object):
    ...
    def save(
        self, dst: Union[Text, SupportsWrite[bytes]], buffer_size: int = ...
    ): ...
    def close(self) -> None: ...
