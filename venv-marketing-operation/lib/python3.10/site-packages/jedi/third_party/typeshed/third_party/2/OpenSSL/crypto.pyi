...
_Key = Union[
    rsa.RSAPublicKey, rsa.RSAPrivateKey, dsa.DSAPublicKey, dsa.DSAPrivateKey
]
...
def dump_privatekey(
    ...
    pkey: PKey,
    cipher: Optional[str] = ...,
    passphrase: Optional[Union[str, Callable[[int], int]]] = ...,
) -> bytes: ...
...
class CRL:
    ...
    def sign(
        self, issuer_cert: X509, issuer_key: PKey, digest: str
    ) -> None: ...
    def export(
        self,
        cert: X509,
...
def verify(
    cert: X509, signature: bytes, data: Union[str, unicode], digest: str
) -> None: ...
