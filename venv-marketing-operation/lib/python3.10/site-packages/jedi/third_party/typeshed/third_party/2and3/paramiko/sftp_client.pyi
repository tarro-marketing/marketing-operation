...
class SFTPClient(BaseSFTP, ClosingContextManager):
    ...
    def listdir_iter(
        self, path: Union[bytes, Text] = ..., read_aheads: int = ...
    ) -> Iterator[SFTPAttributes]: ...
    def open(
        self, filename: Union[bytes, Text], mode: str = ..., bufsize: int = ...
    ) -> SFTPFile: ...
    file = open
    def remove(self, path: Union[bytes, Text]) -> None: ...
    unlink = remove
    def rename(
        self, oldpath: Union[bytes, Text], newpath: Union[bytes, Text]
    ) -> None: ...
    def posix_rename(
        self, oldpath: Union[bytes, Text], newpath: Union[bytes, Text]
    ) -> None: ...
    ...
    def symlink(
        self, source: Union[bytes, Text], dest: Union[bytes, Text]
    ) -> None: ...
    def chmod(self, path: Union[bytes, Text], mode: int) -> None: ...
    def chown(self, path: Union[bytes, Text], uid: int, gid: int) -> None: ...
    def utime(
        self, path: Union[bytes, Text], times: Optional[Tuple[float, float]]
    ) -> None: ...
