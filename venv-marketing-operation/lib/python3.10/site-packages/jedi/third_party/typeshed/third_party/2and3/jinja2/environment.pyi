...
class Environment:
    ...
    def parse(
        self, source, name: Optional[Any] = ..., filename: Optional[Any] = ...
    ): ...
    def lex(
        self, source, name: Optional[Any] = ..., filename: Optional[Any] = ...
    ): ...
    ...
    def compile_expression(
        self, source: Text, undefined_to_none: bool = ...
    ): ...
    ...
    def list_templates(
        self, extensions: Optional[Any] = ..., filter_func: Optional[Any] = ...
    ): ...
    def handle_exception(
        self,
        exc_info: Optional[Any] = ...,
        rendered: bool = ...,
        source_hint: Optional[Any] = ...,
    ): ...
    def join_path(
        self, template: Union[Template, Text], parent: Text
    ) -> Text: ...
    def get_template(
        self,
        name: Union[Template, Text],
        parent: Optional[Text] = ...,
        globals: Optional[Any] = ...,
    ) -> Template: ...
    def select_template(
        self,
        names: Sequence[Union[Template, Text]],
        parent: Optional[Text] = ...,
    ...
    def get_or_select_template(
        ...
        template_name_or_list: Union[
            Union[Template, Text], Sequence[Union[Template, Text]]
        ],
        parent: Optional[Text] = ...,
        globals: Optional[Dict[str, Any]] = ...,
    ) -> Template: ...
    def from_string(
        ...
        source: Text,
        globals: Optional[Dict[str, Any]] = ...,
        template_class: Optional[Type[Template]] = ...,
    ) -> Template: ...
    ...
    def install_gettext_translations(
        self, translations: Any, newstyle: Optional[bool] = ...
    ): ...
...
class Template:
    ...
    @classmethod
    def from_code(
        cls, environment, code, globals, uptodate: Optional[Any] = ...
    ): ...
    @classmethod
