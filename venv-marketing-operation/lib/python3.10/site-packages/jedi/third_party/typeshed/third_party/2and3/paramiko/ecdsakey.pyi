...
from cryptography.hazmat.primitives.asymmetric.ec2 import (
    EllipticCurve,
...
class ECDSAKey(PKey):
    ...
    def write_private_key_file(
        self, filename: str, password: Optional[str] = ...
    ) -> None: ...
    def write_private_key(
        self, file_obj: IO[str], password: Optional[str] = ...
    ) -> None: ...
    @classmethod
    def generate(
        cls,
        curve: EllipticCurve = ...,
        progress_func: Optional[Callable[..., Any]] = ...,
        bits: Optional[int] = ...,
    ) -> ECDSAKey: ...
