...
class Transport(Thread, ClosingContextManager):
    ...
    def set_gss_host(
        ...
        trust_dns: bool = ...,
        gssapi_requested: bool = ...,
    ) -> None: ...
    def start_client(
        self, event: Optional[Event] = ..., timeout: Optional[float] = ...
    ) -> None: ...
    def start_server(
        self, event: Event = ..., server: Optional[ServerInterface] = ...
    ) -> None: ...
    ...
    def request_port_forward(
        ...
        address: str,
        port: int,
        handler: Optional[Callable[[Channel, _Addr, _Addr], None]] = ...,
    ) -> int: ...
    ...
    def global_request(
        self, kind: str, data: Optional[Iterable[Any]] = ..., wait: bool = ...
    ) -> Optional[Message]: ...
    ...
    def auth_publickey(
        self, username: str, key: PKey, event: Optional[Event] = ...
    ) -> List[str]: ...
    ...
    def auth_interactive_dumb(
        self,
        username: str,
        handler: Optional[_InteractiveCallback] = ...,
        submethods: str = ...,
    ) -> List[str]: ...
