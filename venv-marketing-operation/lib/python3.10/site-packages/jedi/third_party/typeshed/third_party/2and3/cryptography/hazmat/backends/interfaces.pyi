...
class DERSerializationBackend(metaclass=ABCMeta):
    ...
    def load_der_private_key(
        self, data: bytes, password: Optional[bytes]
    ) -> Any: ...
    @abstractmethod
...
class DHBackend(metaclass=ABCMeta):
    ...
    def dh_parameters_supported(
        self, p: int, g: int, q: Optional[int]
    ) -> bool: ...
    @abstractmethod
    ...
    def load_dh_parameter_numbers(
        self, numbers: DHParameterNumbers
    ) -> DHParameters: ...
    @abstractmethod
    def load_dh_private_numbers(
        self, numbers: DHPrivateNumbers
    ) -> DHPrivateKey: ...
    @abstractmethod
    def load_dh_public_numbers(
        self, numbers: DHPublicNumbers
    ) -> DHPublicKey: ...
...
class DSABackend(metaclass=ABCMeta):
    ...
    def load_dsa_parameter_numbers(
        self, numbers: DSAParameterNumbers
    ) -> DSAParameters: ...
    @abstractmethod
    def load_dsa_private_numbers(
        self, numbers: DSAPrivateNumbers
    ) -> DSAPrivateKey: ...
    @abstractmethod
    def load_dsa_public_numbers(
        self, numbers: DSAPublicNumbers
    ) -> DSAPublicKey: ...

class EllipticCurveBackend(metaclass=ABCMeta):
    @abstractmethod
    def derive_elliptic_curve_private_key(
        self, private_value: int, curve: EllipticCurve
    ) -> EllipticCurvePrivateKey: ...
    @abstractmethod
    ...
    def load_elliptic_curve_private_numbers(
        self, numbers: EllipticCurvePrivateNumbers
    ) -> EllipticCurvePrivateKey: ...
    @abstractmethod
    def load_elliptic_curve_public_numbers(
        self, numbers: EllipticCurvePublicNumbers
    ) -> EllipticCurvePublicKey: ...

class HMACBackend(metaclass=ABCMeta):
    @abstractmethod
    def create_hmac_ctx(
        self, key: bytes, algorithm: HashAlgorithm
    ) -> HashContext: ...
    @abstractmethod
...
class RSABackend(metaclass=ABCMeta):
    ...
    def load_rsa_public_numbers(
        self, numbers: RSAPublicNumbers
    ) -> RSAPublicKey: ...
    @abstractmethod
    def load_rsa_private_numbers(
        self, numbers: RSAPrivateNumbers
    ) -> RSAPrivateKey: ...
    @abstractmethod
...
class X509Backend(metaclass=ABCMeta):
    ...
    def create_x509_certificate(
        ...
        private_key: Union[
            DSAPrivateKey, EllipticCurvePrivateKey, RSAPrivateKey
        ],
        algorithm: HashAlgorithm,
    ) -> Certificate: ...
    @abstractmethod
