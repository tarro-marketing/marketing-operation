...
_DistFinderType = Callable[
    [_Importer, str, bool], Generator[Distribution, None, None]
]
...
class Environment:
    ...
    def __add__(
        self, other: Union[Distribution, Environment]
    ) -> Environment: ...
    def __iadd__(
        self, other: Union[Distribution, Environment]
    ) -> Environment: ...
    @overload
    def best_match(
        self, req: Requirement, working_set: WorkingSet
    ) -> Distribution: ...
    @overload
    def best_match(
        self,
        req: Requirement,
        working_set: WorkingSet,
        installer: Callable[[Requirement], _T] = ...,
    ) -> _T: ...
    @overload
...
class Requirement:
    ...
    def __contains__(
        self, item: Union[Distribution, str, Tuple[str, ...]]
    ) -> bool: ...
...
class EntryPoint:
    ...
    @classmethod
    def parse(
        cls, src: str, dist: Optional[Distribution] = ...
    ) -> EntryPoint: ...
    @classmethod
    def parse_group(
        cls,
    ...
    def parse_map(
        cls,
        data: Union[Dict[str, Union[str, Sequence[str]]], str, Sequence[str]],
        dist: Optional[Distribution] = ...,
    ) -> Dict[str, EntryPoint]: ...
    def load(
        self,
...
def get_distribution(
    dist: Union[Requirement, str, Distribution]
) -> Distribution: ...
...
def resource_exists(
    package_or_requirement: _PkgReqType, resource_name: str
) -> bool: ...
def resource_stream(
    package_or_requirement: _PkgReqType, resource_name: str
) -> IO[bytes]: ...
...
class IResourceManager:
    ...
    def get_cache_path(
        self, archive_name: str, names: Iterable[str] = ...
    ) -> str: ...
...
class IMetadataProvider:
    ...
    def run_script(
        self, script_name: str, namespace: Dict[str, Any]
    ) -> None: ...
...
class VersionConflict(ResolutionError):
    ...
    def report(self) -> str: ...
    def with_context(
        self, required_by: Set[Union[Distribution, str]]
    ) -> VersionConflict: ...
...
def register_finder(
    importer_type: type, distribution_finder: _DistFinderType
) -> None: ...
...
def register_namespace_handler(
    importer_type: type, namespace_handler: _NSHandlerType
) -> None: ...
...
def compatible_platforms(
    provided: Optional[str], required: Optional[str]
) -> bool: ...
