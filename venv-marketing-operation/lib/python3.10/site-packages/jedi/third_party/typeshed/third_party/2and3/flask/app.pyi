...
class Flask(_PackageBoundObject):
    ...
    after_request_funcs: Dict[
        Optional[str], List[Callable[[Response], Response]]
    ] = ...
    teardown_request_funcs: Dict[
        Optional[str], List[Callable[[Optional[Exception]], Any]]
    ] = ...
    ...
    def open_instance_resource(
        self, resource: Union[str, Text], mode: str = ...
    ): ...
    ...
    def test_client(
        self, use_cookies: bool = ..., **kwargs: Any
    ...
    def teardown_request(
        self, f: Callable[[Optional[Exception]], _T]
    ...
    def handle_url_build_error(
        self, error: Any, endpoint: Any, values: Any
    ): ...
