...
class Type(google___protobuf___message___Message):
    ...
    name: typing___Text = ...
    oneofs: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        typing___Text
    ] = ...
    ...
    def __init__(
        ...
        *,
        ...
        source_context: typing___Optional[
            google___protobuf___source_context_pb2___SourceContext
        ] = None,
...
class Enum(google___protobuf___message___Message):
    ...
    def __init__(
        ...
        *,
        name: typing___Optional[typing___Text] = None,
        enumvalue: typing___Optional[
            typing___Iterable[type___EnumValue]
        ] = None,
        options: typing___Optional[typing___Iterable[type___Option]] = None,
        source_context: typing___Optional[
            google___protobuf___source_context_pb2___SourceContext
