...
class Session(SessionRedirectMixin):
    ...
    auth: Union[
        None, Tuple[Text, Text], _auth.AuthBase, Callable[[Request], Request]
    ]
    ...
    def request(
        ...
        cookies: Union[
            None, RequestsCookieJar, MutableMapping[Text, Text]
        ] = ...,
    ...
    def put(
        self, url: Union[Text, bytes], data: _Data = ..., **kwargs
    ) -> Response: ...
    def patch(
        self, url: Union[Text, bytes], data: _Data = ..., **kwargs
    ) -> Response: ...
    ...
    def close(self) -> None: ...
    def mount(
        self, prefix: Union[Text, bytes], adapter: BaseAdapter
    ) -> None: ...
