...
class SigningAlgorithm(object):
    ...
    def verify_signature(
        self, key: bytes, value: bytes, sig: bytes
    ) -> bool: ...
...
class HMACAlgorithm(SigningAlgorithm):
    ...
    def __init__(
        self, digest_method: Optional[Callable[..., Any]] = ...
    ) -> None: ...
    def get_signature(self, key: bytes, value: bytes) -> bytes: ...
...
class Signer(object):
    ...
    def verify_signature(
        self, value: bytes, sig: Union[Text, bytes]
    ) -> bool: ...
...
class JSONWebSignatureSerializer(Serializer):
    ...
    def load_payload(
        ...
        Any
    ): ...  # morally -> Union[Any, Tuple[Any, MutableMapping[str, Any]]]
