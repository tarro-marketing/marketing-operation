...
class Struct(
    ...
    google___protobuf___internal___well_known_types___Struct,
):
    ...
    def fields(
        ...
        typing___Text, type___Value
    ]: ...
    def __init__(
        self,
        *,
        fields: typing___Optional[
            typing___Mapping[typing___Text, type___Value]
        ] = None,
    ) -> None: ...
    def ClearField(
...
class ListValue(
    google___protobuf___message___Message,
    google___protobuf___internal___well_known_types___ListValue,
):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
