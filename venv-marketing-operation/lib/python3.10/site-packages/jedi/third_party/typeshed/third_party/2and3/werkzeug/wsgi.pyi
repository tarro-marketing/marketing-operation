...
from .middleware.shared_data import (
    SharedDataMiddleware as SharedDataMiddleware,
)
...
def get_input_stream(
    environ: WSGIEnvironment, safe_fallback: bool = ...
) -> InputStream: ...
...
def wrap_file(
    environ: WSGIEnvironment, file: SupportsRead[bytes], buffer_size: int = ...
) -> Iterable[bytes]: ...
...
class FileWrapper:
    ...
    buffer_size: int
    def __init__(
        self, file: SupportsRead[bytes], buffer_size: int = ...
    ) -> None: ...
    def close(self) -> None: ...
...
class _RangeWrapper:
    ...
    end_reached: Any
    def __init__(
        self, iterable, start_byte: int = ..., byte_range: Optional[Any] = ...
    ): ...
    def __iter__(self): ...
    def __next__(self): ...
    def close(self): ...
