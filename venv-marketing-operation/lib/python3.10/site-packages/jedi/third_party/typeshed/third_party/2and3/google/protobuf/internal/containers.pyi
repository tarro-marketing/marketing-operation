...
class BaseContainer(Sequence[_T]):
    ...
    def sort(
        self, *, key: Optional[Callable[[_T], Any]] = ..., reverse: bool = ...
    ) -> None: ...
    @overload
...
class RepeatedScalarFieldContainer(BaseContainer[_T]):
    def __init__(
        self, message_listener: MessageListener, message_descriptor: Descriptor
    ) -> None: ...
    ...
    def __setslice__(
        self, start: int, stop: int, values: Iterable[_T]
    ) -> None: ...
...
class RepeatedCompositeFieldContainer(BaseContainer[_T]):
    def __init__(
        self, message_listener: MessageListener, type_checker: Any
    ) -> None: ...
