...
def poll(
    timeout: float = ..., map: Optional[Mapping[int, SocketType]] = ...
) -> None: ...
def poll2(
    timeout: float = ..., map: Optional[Mapping[int, SocketType]] = ...
) -> None: ...
...
def loop(
    timeout: float = ...,
    use_poll: bool = ...,
    map: Optional[Mapping[int, SocketType]] = ...,
    count: Optional[int] = ...,
) -> None: ...
...
class dispatcher:
    ...
    def add_channel(
        self, map: Optional[Mapping[int, SocketType]] = ...
    ) -> None: ...
    def del_channel(
        self, map: Optional[Mapping[int, SocketType]] = ...
    ) -> None: ...
    ...
    def set_socket(
        self, sock: SocketType, map: Optional[Mapping[int, SocketType]] = ...
    ) -> None: ...
...
def close_all(
    map: Optional[Mapping[int, SocketType]] = ..., ignore_all: bool = ...
) -> None: ...
...
class file_wrapper:
    ...
    def getsockopt(
        self, level: int, optname: int, buflen: Optional[bool] = ...
    ) -> int: ...
    read: Callable[..., bytes] = ...
...
class file_dispatcher(dispatcher):
    connected: bool = ...
    def __init__(
        self, fd: BytesIO, map: Optional[Mapping[int, SocketType]] = ...
    ) -> None: ...
    socket: SocketType = ...
