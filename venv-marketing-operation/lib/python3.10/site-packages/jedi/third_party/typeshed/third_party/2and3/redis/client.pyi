...
class Redis(Generic[_StrType]):
    ...
    def pipeline(
        self, transaction: bool = ..., shard_hint: Any = ...
    ) -> Pipeline: ...
    ...
    def pubsub(
        self, shard_hint: Any = ..., ignore_subscribe_messages: bool = ...
    ) -> PubSub: ...
    ...
    def bitcount(
        self, key: _Key, start: Optional[int] = ..., end: Optional[int] = ...
    ) -> int: ...
    ...
    def setex(
        self, name: _Key, time: Union[int, timedelta], value: _Value
    ) -> bool: ...
    ...
    def unwatch(self): ...
    def blpop(
        self, keys: Union[_Value, Iterable[_Value]], timeout: int = ...
    ...
    def xpending_range(
        self, name, groupname, min, max, count, consumername=...
    ): ...
    def xrange(self, name, min=..., max=..., count=...): ...
    def xread(self, streams, count=..., block=...): ...
    def xreadgroup(
        self, groupname, consumername, streams, count=..., block=..., noack=...
    ): ...
    ...
    def zrange(
        self, name, start, end, desc=..., withscores=..., score_cast_func=...
    ): ...
    ...
    def zremrangebyscore(
        self, name: _Key, min: _Value, max: _Value
    ) -> int: ...
    def zrevrange(
        self, name, start, end, withscores=..., score_cast_func=...
    ): ...
    ...
    def hincrbyfloat(
        self, name: _Key, key: _Key, amount: float = ...
    ) -> float: ...
...
class PubSub:
    ...
    def __init__(
        self, connection_pool, shard_hint=..., ignore_subscribe_messages=...
    ) -> None: ...
    def __del__(self): ...
    channels: Any
    patterns: Any
    ...
    def subscribe(
        self, *args: _Key, **kwargs: Callable[[Any], None]
    ) -> None: ...
    ...
    def handle_message(
        self, response, ignore_subscribe_messages: bool = ...
    ) -> Optional[Dict[str, Any]]: ...
