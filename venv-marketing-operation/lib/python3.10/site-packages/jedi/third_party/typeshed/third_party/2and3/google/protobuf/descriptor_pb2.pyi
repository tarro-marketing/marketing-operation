...
class FileDescriptorSet(google___protobuf___message___Message):
    ...
    def __init__(
        self,
        *,
        file: typing___Optional[
            typing___Iterable[type___FileDescriptorProto]
        ] = None,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions___Literal["file", b"file"]
    ) -> None: ...
...
class FileDescriptorProto(google___protobuf___message___Message):
    ...
    dependency: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        typing___Text
    ] = ...
    public_dependency: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        builtin___int
    ] = ...
    weak_dependency: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        builtin___int
    ] = ...
    ...
    def message_type(
        ...
        type___DescriptorProto
    ]: ...
    @property
    def enum_type(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[
        type___EnumDescriptorProto
    ]: ...
    @property
    def service(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[
        type___ServiceDescriptorProto
    ]: ...
    @property
    def extension(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[
        type___FieldDescriptorProto
    ]: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        public_dependency: typing___Optional[
            typing___Iterable[builtin___int]
        ] = None,
        weak_dependency: typing___Optional[
            typing___Iterable[builtin___int]
        ] = None,
        message_type: typing___Optional[
            typing___Iterable[type___DescriptorProto]
        ] = None,
        enum_type: typing___Optional[
            typing___Iterable[type___EnumDescriptorProto]
        ] = None,
        service: typing___Optional[
            typing___Iterable[type___ServiceDescriptorProto]
        ] = None,
        extension: typing___Optional[
            typing___Iterable[type___FieldDescriptorProto]
        ] = None,
...
class DescriptorProto(google___protobuf___message___Message):
    ...
    class ExtensionRange(google___protobuf___message___Message):
        ...
        def HasField(
            self,
            field_name: typing_extensions___Literal[
                "end", b"end", "options", b"options", "start", b"start"
            ],
        ) -> builtin___bool: ...
        def ClearField(
            self,
    ...
    name: typing___Text = ...
    reserved_name: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        typing___Text
    ] = ...
    ...
    def extension_range(
        ...
        type___DescriptorProto.ExtensionRange
    ]: ...
    @property
    def oneof_decl(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[
        type___OneofDescriptorProto
    ]: ...
    @property
    ...
    def __init__(
        ...
        *,
        name: typing___Optional[typing___Text] = None,
        field: typing___Optional[
            typing___Iterable[type___FieldDescriptorProto]
        ] = None,
        extension: typing___Optional[
            typing___Iterable[type___FieldDescriptorProto]
        ] = None,
        nested_type: typing___Optional[
            typing___Iterable[type___DescriptorProto]
        ] = None,
        enum_type: typing___Optional[
            typing___Iterable[type___EnumDescriptorProto]
        ] = None,
        extension_range: typing___Optional[
            typing___Iterable[type___DescriptorProto.ExtensionRange]
        ] = None,
        oneof_decl: typing___Optional[
            typing___Iterable[type___OneofDescriptorProto]
        ] = None,
        options: typing___Optional[type___MessageOptions] = None,
        reserved_range: typing___Optional[
            typing___Iterable[type___DescriptorProto.ReservedRange]
        ] = None,
        reserved_name: typing___Optional[
...
class ExtensionRangeOptions(google___protobuf___message___Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "uninterpreted_option", b"uninterpreted_option"
        ],
    ) -> None: ...
...
class FieldDescriptorProto(google___protobuf___message___Message):
    ...
    class _Type(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[
            FieldDescriptorProto.TypeValue
        ]
    ):
    ...
    class _Label(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[
            FieldDescriptorProto.LabelValue
        ]
    ):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    ...
    def __init__(
        ...
        *,
        ...
        label: typing___Optional[
            type___FieldDescriptorProto.LabelValue
        ] = None,
...
class EnumDescriptorProto(google___protobuf___message___Message):
    ...
    def reserved_range(
        ...
        type___EnumDescriptorProto.EnumReservedRange
    ]: ...
    def __init__(
        self,
        *,
        ...
        value: typing___Optional[
            typing___Iterable[type___EnumValueDescriptorProto]
        ] = None,
        options: typing___Optional[type___EnumOptions] = None,
        reserved_range: typing___Optional[
            typing___Iterable[type___EnumDescriptorProto.EnumReservedRange]
        ] = None,
        reserved_name: typing___Optional[
            typing___Iterable[typing___Text]
        ] = None,
...
class EnumValueDescriptorProto(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal[
            "name", b"name", "number", b"number", "options", b"options"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class ServiceDescriptorProto(google___protobuf___message___Message):
    ...
    def __init__(
        ...
        *,
        name: typing___Optional[typing___Text] = None,
        method: typing___Optional[
            typing___Iterable[type___MethodDescriptorProto]
        ] = None,
    ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "method", b"method", "name", b"name", "options", b"options"
        ],
    ) -> None: ...
...
class FileOptions(google___protobuf___message___Message):
    ...
    def __init__(
        ...
        *,
        ...
        java_generate_equals_and_hash: typing___Optional[
            builtin___bool
        ] = None,
        java_string_check_utf8: typing___Optional[builtin___bool] = None,
        optimize_for: typing___Optional[
            type___FileOptions.OptimizeModeValue
        ] = None,
...
class MessageOptions(google___protobuf___message___Message):
    ...
    def __init__(
        ...
        *,
        ...
        no_standard_descriptor_accessor: typing___Optional[
            builtin___bool
        ] = None,
        deprecated: typing___Optional[builtin___bool] = None,
...
class EnumOptions(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal[
            "allow_alias", b"allow_alias", "deprecated", b"deprecated"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class EnumValueOptions(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal["deprecated", b"deprecated"],
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
...
class MethodOptions(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    IdempotencyLevelValue = typing___NewType(
        "IdempotencyLevelValue", builtin___int
    )
    ...
    class _IdempotencyLevel(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[
            MethodOptions.IdempotencyLevelValue
        ]
    ):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        IDEMPOTENCY_UNKNOWN = typing___cast(
            MethodOptions.IdempotencyLevelValue, 0
        )
    ...
    def __init__(
        ...
        *,
        deprecated: typing___Optional[builtin___bool] = None,
        idempotency_level: typing___Optional[
            type___MethodOptions.IdempotencyLevelValue
        ] = None,
        uninterpreted_option: typing___Optional[
            typing___Iterable[type___UninterpretedOption]
        ] = None,
...
class UninterpretedOption(google___protobuf___message___Message):
    ...
    class NamePart(google___protobuf___message___Message):
        ...
        def HasField(
            self,
            field_name: typing_extensions___Literal[
                "is_extension", b"is_extension", "name_part", b"name_part"
            ],
        ) -> builtin___bool: ...
        def ClearField(
            self,
    ...
    def name(
        ...
        type___UninterpretedOption.NamePart
    ]: ...
    def __init__(
        self,
        *,
        name: typing___Optional[
            typing___Iterable[type___UninterpretedOption.NamePart]
        ] = None,
...
class SourceCodeInfo(google___protobuf___message___Message):
    ...
    class Location(google___protobuf___message___Message):
        ...
        span: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
            builtin___int
        ] = ...
        ...
        def __init__(
            ...
            *,
            ...
            leading_detached_comments: typing___Optional[
                typing___Iterable[typing___Text]
            ] = None,
        ) -> None: ...
        def HasField(
    ...
    def location(
        ...
        type___SourceCodeInfo.Location
    ]: ...
    def __init__(
        self,
        *,
        location: typing___Optional[
            typing___Iterable[type___SourceCodeInfo.Location]
        ] = None,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions___Literal["location", b"location"]
    ) -> None: ...
...
class GeneratedCodeInfo(google___protobuf___message___Message):
    ...
    class Annotation(google___protobuf___message___Message):
        ...
        def HasField(
            self,
            field_name: typing_extensions___Literal[
                "begin", b"begin", "end", b"end", "source_file", b"source_file"
            ],
        ) -> builtin___bool: ...
        def ClearField(
            self,
    ...
    def annotation(
        ...
        type___GeneratedCodeInfo.Annotation
    ]: ...
    def __init__(
        self,
        *,
        annotation: typing___Optional[
            typing___Iterable[type___GeneratedCodeInfo.Annotation]
        ] = None,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal["annotation", b"annotation"],
    ) -> None: ...
