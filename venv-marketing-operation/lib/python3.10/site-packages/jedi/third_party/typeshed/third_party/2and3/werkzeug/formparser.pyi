...
_Dict = Any
_ParseFunc = Callable[
    [IO[bytes], str, Optional[int], Mapping[str, str]],
...
def parse_multipart_headers(
    iterable: Iterable[Union[Text, bytes]]
) -> Headers: ...
...
class MultiPartParser(object):
    ...
    def parse_parts(
        self, file: Any, boundary: bytes, content_length: int
    ) -> Generator[Tuple[str, Any], None, None]: ...
    def parse(
        self, file: Any, boundary: bytes, content_length: int
    ) -> Tuple[_Dict, _Dict]: ...
