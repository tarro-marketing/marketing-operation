...
def create_bound_method(
    func: types.FunctionType, obj: object
) -> types.MethodType: ...
...
def assertRaisesRegex(
    self: unittest.TestCase, msg: Optional[str] = ...
) -> Any: ...
@overload
def assertRaisesRegex(
    self: unittest.TestCase,
...
def ensure_binary(
    s: Union[bytes, str], encoding: str = ..., errors: str = ...
) -> bytes: ...
def ensure_str(
    s: Union[bytes, str], encoding: str = ..., errors: str = ...
) -> str: ...
...
class MovedModule(_LazyDescriptor):
    mod: str
    def __init__(
        self, name: str, old: str, new: Optional[str] = ...
    ) -> None: ...
