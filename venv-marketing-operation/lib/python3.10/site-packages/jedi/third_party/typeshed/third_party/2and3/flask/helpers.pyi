...
def get_flashed_messages(
    with_categories: bool = ..., category_filter: Any = ...
): ...
def send_file(
    filename_or_fp: Any,
...
def send_from_directory(
    directory: Any, filename: Any, **options: Any
) -> Response: ...
...
class locked_cached_property:
    ...
    lock: Any = ...
    def __init__(
        self, func: Any, name: Optional[Any] = ..., doc: Optional[Any] = ...
    ) -> None: ...
...
class _PackageBoundObject:
    ...
    def __init__(
        self,
        import_name: Any,
        template_folder: Optional[Any] = ...,
        root_path: Optional[Any] = ...,
    ) -> None: ...
    static_folder: Any = ...
    static_url_path: Any = ...
    @property
