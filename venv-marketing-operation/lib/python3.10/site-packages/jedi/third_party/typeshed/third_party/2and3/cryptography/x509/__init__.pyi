...
class Name(object):
    ...
    def __init__(
        self,
        attributes: Sequence[Union[NameAttribute, RelativeDistinguishedName]],
    ) -> None: ...
    def __iter__(self) -> Generator[NameAttribute, None, None]: ...
...
class CertificateBuilder(object):
    ...
    def add_extension(
        self, extension: ExtensionType, critical: bool
    ) -> CertificateBuilder: ...
...
class RevokedCertificateBuilder(object):
    ...
    def build(
        self, backend: Optional[X509Backend] = ...
    ) -> RevokedCertificate: ...
    def revocation_date(
        self, time: datetime.datetime
    ) -> RevokedCertificateBuilder: ...
...
class IPAddress(GeneralName):
    ...
    def __init__(
        self, value: Union[IPv4Address, IPv6Address, IPv4Network, IPv6Network]
    ) -> None: ...
...
def load_der_x509_certificate(
    data: bytes, backend: Optional[X509Backend] = ...
) -> Certificate: ...
