...
class DescriptorBase(metaclass=DescriptorMetaclass):
    has_options: Any
    def __init__(
        self, options, serialized_options, options_class_name
    ) -> None: ...
    def GetOptions(self): ...
...
class EnumValueDescriptor(DescriptorBase):
    def __new__(
        cls, name, index, number, type=..., options=..., serialized_options=...
    ): ...
    name: Any
    index: Any
    number: Any
...
class OneofDescriptor:
    ...
    fields: Any
    def __init__(
        self, name, full_name, index, containing_type, fields
    ) -> None: ...
...
def MakeDescriptor(
    desc_proto, package=..., build_file_if_cpp=..., syntax=...
): ...
