...
class _HashAlg:
    def __call__(
        self, arg: Union[bytes, bytearray, memoryview] = ...
    ) -> _Hash: ...
...
class RSAAlgorithm(Algorithm[Any]):
    ...
    def prepare_key(
        self, key: Union[bytes, str, RSAPrivateKey, RSAPublicKey]
    ) -> Union[RSAPrivateKey, RSAPublicKey]: ...
    @staticmethod
    def from_jwk(
        jwk: Union[str, bytes, Dict[str, Any]]
    ) -> Union[RSAPrivateKey, RSAPublicKey]: ...
...
class ECAlgorithm(Algorithm[Any]):
    ...
    def prepare_key(
        self,
        key: Union[
            bytes, str, EllipticCurvePrivateKey, EllipticCurvePublicKey
        ],
    ...
    def verify(
        self, msg: bytes, key: EllipticCurvePublicKey, sig: bytes
    ) -> bool: ...
...
class Ed25519Algorithm(Algorithm[Any]):
    ...
    def prepare_key(
        self, key: Union[str, bytes, Ed25519PrivateKey, Ed25519PublicKey]
    ) -> Any: ...
    def sign(
        self, msg: Union[str, bytes], key: Ed25519PrivateKey
    ) -> bytes: ...
    def verify(
        self,
        msg: Union[str, bytes],
