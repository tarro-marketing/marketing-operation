...
class BuildError(RoutingException, LookupError):
    ...
    def __init__(
        self, endpoint, values, method, adapter: Optional[MapAdapter] = ...
    ) -> None: ...
    @property
    def suggested(self) -> Optional[Rule]: ...
    def closest_rule(
        self, adapter: Optional[MapAdapter]
    ) -> Optional[Rule]: ...
...
class FloatConverter(NumberConverter):
    ...
    num_convert: Any
    def __init__(
        self, map, min: Optional[Any] = ..., max: Optional[Any] = ...
    ): ...
...
class MapAdapter:
    ...
    def test(
        self, path_info: Optional[Any] = ..., method: Optional[Any] = ...
    ): ...
