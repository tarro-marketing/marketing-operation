...
class EllipticCurvePrivateNumbers(object):
    ...
    def private_key(
        self, backend: Optional[EllipticCurveBackend] = ...
...
class EllipticCurvePublicKey(metaclass=ABCMeta):
    ...
    @abstractmethod
    def public_bytes(
        self, encoding: Encoding, format: PublicFormat
    ) -> bytes: ...
    @abstractmethod
    def public_numbers(self) -> EllipticCurvePublicNumbers: ...
    @abstractmethod
...
def derive_private_key(
    private_value: int,
    curve: EllipticCurve,
    backend: Optional[EllipticCurveBackend] = ...,
) -> EllipticCurvePrivateKey: ...
def generate_private_key(
    curve: EllipticCurve, backend: Optional[EllipticCurveBackend] = ...
) -> EllipticCurvePrivateKey: ...
