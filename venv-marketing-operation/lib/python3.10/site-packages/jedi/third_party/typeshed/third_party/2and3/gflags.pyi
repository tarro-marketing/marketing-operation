...
class FlagValues:
    ...
    def __call__(
        self, argv: List[str], known_only: bool = ...
    ) -> List[str]: ...
    def reset(self) -> None: ...
    Reset = reset
    ...
    def ShortestUniquePrefixes(
        self, fl: Dict[str, Flag]
    ) -> Dict[str, str]: ...
    def ExtractFilename(self, flagfile_str: str) -> str: ...
    def read_flags_from_files(
        self, argv: List[str], force_gnu: bool = ...
    ) -> List[str]: ...
...
class ArgumentParser(object):
    ...
    Type = flag_type
    def WriteCustomInfoInXMLFormat(
        self, outfile: IO[str], indent: str
    ) -> None: ...
...
def mark_flag_as_required(
    flag_name: str, flag_values: FlagValues = ...
) -> None: ...

MarkFlagAsRequired = mark_flag_as_required

def mark_flags_as_required(
    flag_names: Iterable[str], flag_values: FlagValues = ...
) -> None: ...
...
def adopt_module_key_flags(
    module: ModuleType, flag_values: FlagValues = ...
) -> None: ...
