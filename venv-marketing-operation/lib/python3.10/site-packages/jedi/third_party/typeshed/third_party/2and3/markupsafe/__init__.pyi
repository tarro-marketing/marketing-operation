...
from markupsafe._native import (
    escape as escape,
    escape_silent as escape_silent,
    soft_unicode as soft_unicode,
)
...
class Markup(text_type):
    ...
    def split(
        self, sep: Optional[text_type] = ..., maxsplit: int = ...
    ) -> List[text_type]: ...
    def rsplit(
        self, sep: Optional[text_type] = ..., maxsplit: int = ...
    ) -> List[text_type]: ...
    ...
    def replace(
        self, old: text_type, new: text_type, count: int = ...
    ) -> Markup: ...
    ...
    def translate(
        self,
        table: Union[
            Mapping[int, Union[int, text_type, None]],
            Sequence[Union[int, text_type, None]],
        ],
    ) -> Markup: ...
...
class EscapeFormatter(string.Formatter):
    ...
    def __init__(
        self, escape: Callable[[text_type], Markup]
    ) -> None: ...  # noqa: F811
    def format_field(
        self, value: text_type, format_spec: text_type
    ) -> Markup: ...
