...
_Provider = (
    Any  # TODO replace this with boto.provider.Provider once stubs exist
)
...
def get_aws_metadata(
    headers: Mapping[str, str], provider: Optional[_Provider] = ...
) -> Mapping[str, str]: ...
def retry_url(
    url: str,
    retry_on_404: bool = ...,
...
class LazyLoadMetadata(Dict[_KT, _VT]):
    def __init__(
        self, url: str, num_retries: int, timeout: Optional[int] = ...
    ) -> None: ...
...
def find_class(
    module_name: str, class_name: Optional[str] = ...
) -> Optional[Type[Any]]: ...
def update_dme(
    username: str, password: str, dme_id: str, ip_address: str
) -> str: ...
def fetch_file(
    uri: str,
...
def compute_md5(
    fp: IO[Any], buf_size: int = ..., size: Optional[int] = ...
) -> Tuple[str, str, int]: ...
def compute_hash(
    fp: IO[Any],
    buf_size: int = ...,
...
def find_matching_headers(
    name: str, headers: Mapping[str, Optional[str]]
) -> List[str]: ...
def merge_headers_by_name(
    name: str, headers: Mapping[str, Optional[str]]
) -> str: ...
