...
class RequestHandler:
    ...
    def set_secure_cookie(
        self, name, value, expires_days=..., version=..., **kwargs
    ): ...
    def create_signed_value(self, name, value, version=...): ...
    def get_secure_cookie(
        self, name, value=..., max_age_days=..., min_version=...
    ): ...
...
class Application(httputil.HTTPServerConnectionDelegate):
    ...
    ui_methods: Any
    def __init__(
        self, handlers=..., default_host=..., transforms=..., **settings
    ) -> None: ...
...
class HTTPError(Exception):
    ...
    reason: Any
    def __init__(
        self, status_code, log_message=..., *args, **kwargs
    ) -> None: ...
...
class OutputTransform:
    ...
    def transform_first_chunk(
        self, status_code, headers, chunk, finishing
    ): ...
...
def create_signed_value(
    secret, name, value, version=..., clock=..., key_version=...
): ...
def decode_signed_value(
    secret, name, value, max_age_days=..., clock=..., min_version=...
): ...
