...
class BaseRequest:
    ...
    @overload
    def get_data(
        self, *, as_text: Literal[True], parse_form_data: bool = ...
    ) -> Text: ...
    @overload
    def get_data(
    ...
    @overload
    def get_data(
        self, *, as_text: bool, parse_form_data: bool = ...
    ) -> Any: ...
...
class BaseResponse:
    ...
    def delete_cookie(
        self, key, path: str = ..., domain: Optional[Any] = ...
    ): ...
    @property
