...
class _ExtensionFieldDescriptor(
    FieldDescriptor, Generic[_ContainerMessageT, _ExtenderMessageT]
): ...
...
class _ExtensionDict(Generic[_ContainerMessageT]):
    ...
    def __getitem__(
        self,
        extension_handle: _ExtensionFieldDescriptor[
            _ContainerMessageT, _ExtenderMessageT
        ],
    ) -> _ExtenderMessageT: ...
    @overload
    ...
    @overload
    def __setitem__(
        self, extension_handle: FieldDescriptor, value: Any
    ) -> None: ...
    @overload
    def __delitem__(
        self,
    ...
    def __iter__(
        self,
    ) -> Iterator[_ExtensionFieldDescriptor[_ContainerMessageT, Any]]: ...
