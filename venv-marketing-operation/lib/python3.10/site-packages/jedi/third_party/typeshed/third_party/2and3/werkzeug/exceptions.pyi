...
class HTTPException(Exception):
    ...
    @classmethod
    def wrap(
        cls, exception: Type[Exception], name: Optional[str] = ...
    ) -> Any: ...
    @property
    def name(self) -> str: ...
    def get_description(
    ...
    def get_response(
        self,
        environ: Optional[Union[WSGIEnvironment, _EnvironContainer]] = ...,
    ) -> Response: ...
    def __call__(
...
class Unauthorized(HTTPException):
    ...
    def __init__(
        ...
        description: Optional[Text] = ...,
        response: Optional[Response] = ...,
        www_authenticate: Union[
            None, Tuple[object, ...], List[object], object
        ] = ...,
    ) -> None: ...
...
class Aborter:
    mapping: Any
    def __init__(
        self, mapping: Optional[Any] = ..., extra: Optional[Any] = ...
    ) -> None: ...
    def __call__(
        self, code: Union[int, Response], *args: Any, **kwargs: Any
    ) -> NoReturn: ...

def abort(
    status: Union[int, Response], *args: Any, **kwargs: Any
) -> NoReturn: ...
