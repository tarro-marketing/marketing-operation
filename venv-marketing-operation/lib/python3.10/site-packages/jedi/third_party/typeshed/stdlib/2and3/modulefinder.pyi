...
class Module:  # undocumented
    def __init__(
        self, name: str, file: Optional[str] = ..., path: Optional[str] = ...
    ) -> None: ...
...
class ModuleFinder:
    ...
    def msg(
        self, level: int, str: str, *args: Any
    ) -> None: ...  # undocumented
    ...
    def determine_parent(
        self, caller: Optional[Module], level: int = ...
    ) -> Optional[Module]: ...  # undocumented
    ...
    def ensure_fromlist(
        self, m: Module, fromlist: Iterable[str], recursive: int = ...
    ) -> None: ...  # undocumented
