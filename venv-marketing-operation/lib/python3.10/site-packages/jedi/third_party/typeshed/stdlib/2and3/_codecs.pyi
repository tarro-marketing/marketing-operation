...
def ascii_decode(
    __data: _Decodable, __errors: _Errors = ...
) -> Tuple[Text, int]: ...
def ascii_encode(
    __str: _Encodable, __errors: _Errors = ...
) -> Tuple[bytes, int]: ...

if sys.version_info < (3, 2):
    def charbuffer_encode(
        __data: _Encodable, __errors: _Errors = ...
    ) -> Tuple[bytes, int]: ...

def charmap_decode(
    __data: _Decodable,
    __errors: _Errors = ...,
    __mapping: Optional[_MapT] = ...,
) -> Tuple[Text, int]: ...
def charmap_encode(
    __str: _Encodable,
    __errors: _Errors = ...,
...
def escape_decode(
    __data: _String, __errors: _Errors = ...
) -> Tuple[str, int]: ...
def escape_encode(
    __data: bytes, __errors: _Errors = ...
) -> Tuple[bytes, int]: ...
def latin_1_decode(
    __data: _Decodable, __errors: _Errors = ...
) -> Tuple[Text, int]: ...
...
if sys.version_info < (3, 8):
    def unicode_internal_decode(
        __obj: _String, __errors: _Errors = ...
    ) -> Tuple[Text, int]: ...
...
def utf_16_be_decode(
    __data: _Decodable, __errors: _Errors = ..., __final: int = ...
) -> Tuple[Text, int]: ...
...
def utf_16_encode(
    __str: _Encodable, __errors: _Errors = ..., __byteorder: int = ...
) -> Tuple[bytes, int]: ...
...
if sys.platform == "win32":
    ...
    if sys.version_info >= (3, 0):
        ...
        def code_page_encode(
            __code_page: int, __str: Text, __errors: _Errors = ...
        ) -> Tuple[bytes, int]: ...
    if sys.version_info >= (3, 6):
        def oem_decode(
            __data: bytes, __errors: _Errors = ..., __final: int = ...
        ) -> Tuple[Text, int]: ...
        def oem_encode(
            __str: Text, __errors: _Errors = ...
        ) -> Tuple[bytes, int]: ...
