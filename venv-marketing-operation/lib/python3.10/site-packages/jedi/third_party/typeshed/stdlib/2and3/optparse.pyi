...
class AmbiguousOptionError(BadOptionError):
    ...
    def __init__(
        self, opt_str: _Text, possibilities: Sequence[_Text]
    ) -> None: ...
...
class Option:
    ...
    def _check_opt_strings(
        self, opts: Iterable[Optional[_Text]]
    ) -> List[_Text]: ...
...
class OptionContainer:
    ...
    def format_description(
        self, formatter: Optional[HelpFormatter]
    ) -> Any: ...
...
class Values:
    def __init__(
        self, defaults: Optional[Mapping[str, Any]] = ...
    ) -> None: ...
...
class OptionParser(OptionContainer):
    ...
    def _populate_option_list(
        self, option_list: Iterable[Option], add_help: bool = ...
    ) -> None: ...
    def _process_args(
    ...
    def check_values(
        self, values: Values, args: List[_Text]
