...
class Bdb:
    ...
    def dispatch_return(
        self, frame: FrameType, arg: Any
    ) -> _TraceDispatch: ...
    def dispatch_exception(
        self, frame: FrameType, arg: _ExcInfo
    ) -> _TraceDispatch: ...
    ...
    def set_until(
        self, frame: FrameType, lineno: Optional[int] = ...
    ) -> None: ...
    ...
    def get_stack(
        self, f: Optional[FrameType], t: Optional[TracebackType]
    ) -> Tuple[List[Tuple[FrameType, int]], int]: ...
    def format_stack_entry(
        self, frame_lineno: int, lprefix: str = ...
    ) -> str: ...
    def run(
        self,
        cmd: Union[str, CodeType],
    ...
    def runcall(
        self, __func: Callable[..., _T], *args: Any, **kwds: Any
    ) -> Optional[_T]: ...
