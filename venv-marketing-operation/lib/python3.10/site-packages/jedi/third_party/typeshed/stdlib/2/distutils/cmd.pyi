...
class Command:
    ...
    def ensure_string(
        self, option: str, default: Optional[str] = ...
    ) -> None: ...
    ...
    def set_undefined_options(
        self, src_cmd: Text, *option_pairs: Tuple[str, str]
    ) -> None: ...
    def get_finalized_command(
        self, command: Text, create: int = ...
    ) -> Command: ...
    def reinitialize_command(
        self, command: Union[Command, Text], reinit_subcommands: int = ...
    ) -> Command: ...
    ...
    def move_file(
        self, src: str, dst: str, level: Any = ...
    ) -> str: ...  # level is not used
    def spawn(
        self, cmd: Iterable[str], search_path: int = ..., level: Any = ...
