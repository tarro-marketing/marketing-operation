...
def median_grouped(
    data: Iterable[_Number], interval: _Number = ...
) -> _Number: ...
...
def pstdev(
    data: Iterable[_Number], mu: Optional[_Number] = ...
) -> _Number: ...
def pvariance(
    data: Iterable[_Number], mu: Optional[_Number] = ...
) -> _Number: ...
...
if sys.version_info >= (3, 8):
    def quantiles(
        data: Iterable[_Number], *, n: int = ..., method: str = ...
    ) -> List[_Number]: ...

def stdev(
    data: Iterable[_Number], xbar: Optional[_Number] = ...
) -> _Number: ...
def variance(
    data: Iterable[_Number], xbar: Optional[_Number] = ...
) -> _Number: ...
...
if sys.version_info >= (3, 8):
    class NormalDist:
        ...
        @classmethod
        def from_samples(
            cls: Type[_T], data: Iterable[SupportsFloat]
        ) -> _T: ...
        def samples(
            self, n: int, *, seed: Optional[Any] = ...
        ) -> List[float]: ...
