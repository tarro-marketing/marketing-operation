...
class Decimal(object):
    ...
    if sys.version_info >= (3,):
        ...
        def __div__(
            self, other: _Decimal, context: Optional[Context] = ...
        ) -> Decimal: ...
        def __rdiv__(
            self, other: _Decimal, context: Optional[Context] = ...
        ) -> Decimal: ...
        def __ne__(
            self, other: object, context: Optional[Context] = ...
        ) -> bool: ...
    ...
    if sys.version_info >= (3,):
        ...
        def __pow__(
            self, other: _Decimal, modulo: Optional[_Decimal] = ...
        ) -> Decimal: ...
        ...
        def __abs__(
            self, round: bool = ..., context: Optional[Context] = ...
        ) -> Decimal: ...
        def __add__(
            self, other: _Decimal, context: Optional[Context] = ...
        ) -> Decimal: ...
        ...
        def __ge__(
            self, other: _ComparableNum, context: Optional[Context] = ...
        ) -> bool: ...
        def __gt__(
            self, other: _ComparableNum, context: Optional[Context] = ...
        ) -> bool: ...
        ...
        def __str__(
            self, eng: bool = ..., context: Optional[Context] = ...
        ) -> str: ...
        def __sub__(
            self, other: _Decimal, context: Optional[Context] = ...
        ) -> Decimal: ...
    ...
    def to_integral_exact(
        self, rounding: Optional[str] = ..., context: Optional[Context] = ...
    ) -> Decimal: ...
    ...
    def __format__(
        self, specifier: str, context: Optional[Context] = ...
    ) -> str: ...
...
class Context(object):
    ...
    if sys.version_info >= (3,):
        def __init__(
            ...
            clamp: Optional[int] = ...,
            flags: Union[
                None, Dict[_TrapType, bool], Container[_TrapType]
            ] = ...,
            traps: Union[
                None, Dict[_TrapType, bool], Container[_TrapType]
            ] = ...,
    ...
    def divmod(
        self, __x: _Decimal, __y: _Decimal
    ) -> Tuple[Decimal, Decimal]: ...
    ...
    def power(
        self, a: _Decimal, b: _Decimal, modulo: Optional[_Decimal] = ...
    ) -> Decimal: ...
