...
def getmembers(
    object: object, predicate: Optional[Callable[[Any], bool]] = ...
) -> List[Tuple[str, Any]]: ...
...
def getabsfile(
    object: _SourceObjectType, _filename: Optional[str] = ...
) -> str: ...
...
def getmodule(
    object: object, _filename: Optional[str] = ...
) -> Optional[ModuleType]: ...
...
class Parameter:
    ...
    POSITIONAL_OR_KEYWORD: ClassVar[
        Literal[_ParameterKind.POSITIONAL_OR_KEYWORD]
    ]
...
def formatannotation(
    annotation: object, base_module: Optional[str] = ...
) -> str: ...
...
def unwrap(
    func: Callable[..., Any], *, stop: Optional[Callable[[Any], Any]] = ...
) -> Any: ...
...
def getattr_static(
    obj: object, attr: str, default: Optional[Any] = ...
) -> Any: ...
