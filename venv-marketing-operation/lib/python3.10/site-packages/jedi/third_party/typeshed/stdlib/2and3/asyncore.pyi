...
class dispatcher:
    ...
    if sys.version_info < (3, 5):
        ...
        @overload
        def getsockopt(
            self, level: int, optname: int, buflen: None = ...
        ) -> int: ...
        @overload
        def getsockopt(
        ...
        def ioctl(
            self, control: object, option: Tuple[int, int, int]
        ) -> None: ...
        ...
        def recvfrom_into(
            self, buffer: bytes, nbytes: int, flags: int = ...
        ) -> Any: ...
        def recv_into(
            self, buffer: bytes, nbytes: int, flags: int = ...
        ) -> Any: ...
...
def close_all(
    map: Optional[_maptype] = ..., ignore_all: bool = ...
) -> None: ...
...
if sys.platform != "win32":
    ...
    class file_dispatcher(dispatcher):
        def __init__(
            self, fd: FileDescriptorLike, map: Optional[_maptype] = ...
        ) -> None: ...
