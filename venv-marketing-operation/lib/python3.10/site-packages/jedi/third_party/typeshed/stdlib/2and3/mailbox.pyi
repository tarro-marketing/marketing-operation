...
class Mailbox(Generic[_MessageType]):
    ...
    def __init__(
        self,
        path: AnyPath,
        factory: Optional[Callable[[IO[Any]], _MessageType]] = ...,
        create: bool = ...,
    ) -> None: ...
...
class mbox(_mboxMMDF[mboxMessage]):
    def __init__(
        self,
        dirname: AnyPath,
        factory: Optional[Callable[[IO[Any]], mboxMessage]] = ...,
        create: bool = ...,
    ) -> None: ...
...
class MMDF(_mboxMMDF[MMDFMessage]):
    def __init__(
        self,
        dirname: AnyPath,
        factory: Optional[Callable[[IO[Any]], MMDFMessage]] = ...,
        create: bool = ...,
    ) -> None: ...
...
class MH(Mailbox[MHMessage]):
    def __init__(
        self,
        dirname: AnyPath,
        factory: Optional[Callable[[IO[Any]], MHMessage]] = ...,
        create: bool = ...,
    ) -> None: ...
    def get_file(self, key: str) -> _ProxyFile[bytes]: ...
    def list_folders(self) -> List[str]: ...
    ...
    def set_sequences(
        self, sequences: Mapping[str, Sequence[int]]
    ) -> None: ...
    def pack(self) -> None: ...
...
class Babyl(_singlefileMailbox[BabylMessage]):
    def __init__(
        self,
        dirname: AnyPath,
        factory: Optional[Callable[[IO[Any]], BabylMessage]] = ...,
        create: bool = ...,
    ) -> None: ...
