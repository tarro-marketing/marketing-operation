...
class RawConfigParser(_parser):
    ...
    def read(
        self,
        filenames: Union[_Path, Iterable[_Path]],
        encoding: Optional[str] = ...,
    ) -> List[str]: ...
    def read_file(
        self, f: Iterable[str], source: Optional[str] = ...
    ) -> None: ...
    def read_string(self, string: str, source: str = ...) -> None: ...
    def read_dict(
        self, dictionary: Mapping[str, Mapping[str, Any]], source: str = ...
    ) -> None: ...
    def readfp(
        self, fp: Iterable[str], filename: Optional[str] = ...
    ) -> None: ...
    ...
    @overload
    def items(
        self, *, raw: bool = ..., vars: Optional[_section] = ...
    ) -> AbstractSet[Tuple[str, SectionProxy]]: ...
    @overload
    def items(
        self, section: str, raw: bool = ..., vars: Optional[_section] = ...
    ) -> List[Tuple[str, str]]: ...
    def set(
        self, section: str, option: str, value: Optional[str] = ...
    ) -> None: ...
    def write(
        self, fp: SupportsWrite[str], space_around_delimiters: bool = ...
    ) -> None: ...
...
class SectionProxy(MutableMapping[str, str]):
    ...
    @overload
    def getint(
        self, option: str, *, raw: bool = ..., vars: Optional[_section] = ...
    ) -> int: ...
    @overload
    def getint(
        self,
...
class ParsingError(Error):
    ...
    def __init__(
        self, source: Optional[str] = ..., filename: Optional[str] = ...
    ) -> None: ...
