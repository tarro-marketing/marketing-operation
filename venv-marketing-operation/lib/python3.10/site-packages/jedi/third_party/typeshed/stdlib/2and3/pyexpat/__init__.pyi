...
class XMLParserType(object):
    def Parse(
        self, __data: Union[Text, bytes], __isfinal: bool = ...
    ) -> int: ...
    ...
    def ExternalEntityParserCreate(
        self, __context: Optional[Text], __encoding: Text = ...
    ) -> XMLParserType: ...
    ...
    StartDoctypeDeclHandler: Optional[
    ...
    UnparsedEntityDeclHandler: Optional[
        Callable[[str, Optional[str], str, Optional[str], str], Any]
    ]
    EntityDeclHandler: Optional[
        Callable[
            [
                str,
                bool,
    ...
    ExternalEntityRefHandler: Optional[
...
def ParserCreate(
    ...
    namespace_separator: Optional[Text] = ...,
    intern: Optional[Dict[str, Any]] = ...,
) -> XMLParserType: ...
