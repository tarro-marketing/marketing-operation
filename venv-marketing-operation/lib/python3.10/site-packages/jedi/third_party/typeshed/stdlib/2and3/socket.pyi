...
class socket:
    ...
    if sys.platform == "win32" and sys.version_info >= (3, 6):
        def ioctl(
            self, control: int, option: Union[int, Tuple[int, int, int], bool]
        ) -> None: ...
    elif sys.platform == "win32":
        def ioctl(
            self, control: int, option: Union[int, Tuple[int, int, int]]
        ) -> None: ...
    ...
    if sys.version_info >= (3,):
        ...
        def makefile(
            self, mode: unicode = ..., buffering: int = ...
        ) -> BinaryIO: ...
    ...
    def sendall(
        self, data: bytes, flags: int = ...
    ) -> None: ...  # return type: None on success
    @overload
    ...
    if sys.version_info >= (3,):
        def sendfile(
            self, file: BinaryIO, offset: int = ..., count: Optional[int] = ...
        ) -> int: ...
...
def getnameinfo(
    sockaddr: Union[Tuple[str, int], Tuple[str, int, int, int]], flags: int
) -> Tuple[str, str]: ...
