...
class ParseError(Exception):
    ...
    context: _Context
    def __init__(
        self, msg: Text, type: int, value: Optional[Text], context: _Context
    ) -> None: ...
...
class Parser:
    ...
    used_names: Set[Text]
    def __init__(
        self, grammar: Grammar, convert: Optional[_Convert] = ...
    ) -> None: ...
    def setup(self, start: Optional[int] = ...) -> None: ...
    def addtoken(
        self, type: int, value: Optional[Text], context: _Context
    ) -> bool: ...
    def classify(
        self, type: int, value: Optional[Text], context: _Context
    ) -> int: ...
