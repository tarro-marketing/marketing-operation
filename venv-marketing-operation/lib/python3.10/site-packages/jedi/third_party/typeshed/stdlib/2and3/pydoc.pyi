...
def visiblename(
    name: str, all: Optional[Container[str]] = ..., obj: Optional[object] = ...
) -> bool: ...
...
def safeimport(
    path: str,
    forceload: bool = ...,
    cache: MutableMapping[str, ModuleType] = ...,
) -> ModuleType: ...

class Doc:
    PYTHONDOCS: str
    def document(
        self, object: object, name: Optional[str] = ..., *args: Any
    ) -> str: ...
    def fail(
        self, object: object, name: Optional[str] = ..., *args: Any
    ) -> NoReturn: ...
    ...
    def getdocloc(
        self, object: object, basedir: str = ...
    ) -> Optional[str]: ...
...
class HTMLDoc(Doc):
    ...
    def multicolumn(
        self, list: List[Any], format: Callable[[Any], str], cols: int = ...
    ) -> str: ...
    ...
    def index(
        self, dir: str, shadowed: Optional[MutableMapping[str, bool]] = ...
    ) -> str: ...
...
def resolve(
    thing: Union[str, object], forceload: bool = ...
) -> Optional[Tuple[object, str]]: ...
def render_doc(
    thing: Union[str, object],
    title: str = ...,
    forceload: bool = ...,
    renderer: Optional[Doc] = ...,
) -> str: ...
def doc(
    thing: Union[str, object],
    title: str = ...,
    forceload: bool = ...,
    output: Optional[SupportsWrite[str]] = ...,
) -> None: ...
def writedoc(thing: Union[str, object], forceload: bool = ...) -> None: ...
def writedocs(
    dir: str, pkgpath: str = ..., done: Optional[Any] = ...
) -> None: ...
...
class Helper:
    ...
    def __init__(
        self, input: Optional[IO[str]] = ..., output: Optional[IO[str]] = ...
    ) -> None: ...
    input: IO[str]
    output: IO[str]
    ...
    def intro(self) -> None: ...
    def list(
        self, items: List[str], columns: int = ..., width: int = ...
    ) -> None: ...
