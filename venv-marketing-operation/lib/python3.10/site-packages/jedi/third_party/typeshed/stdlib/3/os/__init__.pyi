...
if sys.platform != "win32":
    ...
    if sys.version_info >= (3, 7):
        ...
        class statvfs_result(_Tuple10Int):  # Unix only
            def __new__(
                cls,
                seq: Union[_Tuple10Int, _Tuple11Int],
                dict: Dict[str, int] = ...,
            ) -> statvfs_result: ...
            n_fields: int
...
def open(
    path: AnyPath, flags: int, mode: int = ..., *, dir_fd: Optional[int] = ...
) -> int: ...
...
if sys.platform != "win32":
    ...
    @overload
    def sendfile(
        __out_fd: int, __in_fd: int, offset: Optional[int], count: int
    ) -> int: ...
    @overload
    def sendfile(
        __out_fd: int,
...
if sys.platform != "win32":
    def chflags(
        path: AnyPath, flags: int, follow_symlinks: bool = ...
...
def mkdir(
    path: AnyPath, mode: int = ..., *, dir_fd: Optional[int] = ...
) -> None: ...
...
if sys.platform != "win32":
    ...
    def pathconf(
        path: _FdOrAnyPath, name: Union[str, int]
    ) -> int: ...  # Unix only

def readlink(
    path: Union[AnyStr, PathLike[AnyStr]], *, dir_fd: Optional[int] = ...
) -> AnyStr: ...
...
if sys.platform != "win32":
    ...
    if sys.platform == "linux":
        ...
        def listxattr(
            path: _FdOrAnyPath, *, follow_symlinks: bool = ...
        ) -> List[str]: ...
        def removexattr(
            path: _FdOrAnyPath,
            attribute: AnyPath,
...
_ExecEnv = Union[
    Mapping[bytes, Union[bytes, str]], Mapping[str, Union[bytes, str]]
]

def execv(__path: AnyPath, __argv: _ExecVArgs) -> NoReturn: ...
def execve(
    path: _FdOrAnyPath, argv: _ExecVArgs, env: _ExecEnv
) -> NoReturn: ...
...
def spawnle(
    mode: int, file: AnyPath, arg0: AnyPath, *args: Any
) -> int: ...  # Imprecise sig

if sys.platform != "win32":
    def spawnv(mode: int, file: AnyPath, args: _ExecVArgs) -> int: ...
    def spawnve(
        mode: int, file: AnyPath, args: _ExecVArgs, env: _ExecEnv
    ) -> int: ...

else:
    def spawnv(__mode: int, __path: AnyPath, __argv: _ExecVArgs) -> int: ...
    def spawnve(
        __mode: int, __path: AnyPath, __argv: _ExecVArgs, __env: _ExecEnv
    ) -> int: ...
...
if sys.platform == "win32":
    ...
    # Unix only
    def spawnlp(
        mode: int, file: AnyPath, arg0: AnyPath, *args: AnyPath
    ) -> int: ...
    def spawnlpe(
        mode: int, file: AnyPath, arg0: AnyPath, *args: Any
    ...
    if sys.platform == "win32":
        class _AddedDllDirectory:
            ...
            def __init__(
                ...
                path: Optional[str],
                cookie: _T,
                remove_dll_directory: Callable[[_T], Any],
            ) -> None: ...
            def close(self) -> None: ...
