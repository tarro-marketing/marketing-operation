...
class poll:
    ...
    def register(
        self, fd: FileDescriptorLike, eventmask: int = ...
    ) -> None: ...
...
def select(
    __rlist: Iterable[Any],
    __wlist: Iterable[Any],
    __xlist: Iterable[Any],
...
if sys.platform != "linux" and sys.platform != "win32":
    ...
    class kqueue(object):
        ...
        def control(
            self,
            __changelist: Optional[Iterable[kevent]],
            __maxevents: int,
            __timeout: Optional[float] = ...,
        ) -> List[kevent]: ...
        def fileno(self) -> int: ...
...
if sys.platform == "linux":
    class epoll(object):
        ...
        def unregister(self, fd: FileDescriptorLike) -> None: ...
        def poll(
            self, timeout: Optional[float] = ..., maxevents: int = ...
        ) -> List[Tuple[int, int]]: ...
        @classmethod
