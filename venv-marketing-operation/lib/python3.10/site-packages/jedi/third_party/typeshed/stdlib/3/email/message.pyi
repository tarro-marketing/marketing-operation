...
class Message:
    ...
    def add_header(
        self, _name: str, _value: str, **_params: _ParamsType
    ) -> None: ...
    ...
    def del_param(
        self, param: str, header: str = ..., requote: bool = ...
    ) -> None: ...
    def set_type(
        self, type: str, header: str = ..., requote: bool = ...
    ) -> None: ...
...
class MIMEPart(Message):
    def get_body(
        self, preferencelist: Sequence[str] = ...
    ) -> Optional[Message]: ...
