...
def urlopen(
    url: str, data=..., proxies: Mapping[str, str] = ..., context=...
) -> IO[Any]: ...
...
class URLopener:
    ...
    ftpcache: Any
    def __init__(
        self, proxies: Mapping[str, str] = ..., context=..., **x509
    ) -> None: ...
    def __del__(self): ...
    def close(self): ...
    def cleanup(self): ...
...
class ftpwrapper:
    ...
    keepalive: Any
    def __init__(
        self, user, passwd, host, port, dirs, timeout=..., persistent=...
    ) -> None: ...
    busy: Any
    ftp: Any
    def init(self): ...
...
def urlencode(
    query: Union[Sequence[Tuple[Any, Any]], Mapping[Any, Any]], doseq=...
) -> str: ...
