...
if sys.version_info >= (3, 4):
    class WeakMethod(ref[types.MethodType]):
        def __new__(
            ...
            callback: Optional[Callable[[types.MethodType], Any]] = ...,
        ) -> WeakMethod: ...
...
class WeakValueDictionary(MutableMapping[_KT, _VT]):
    ...
    def __init__(
        self,
        __other: Union[Mapping[_KT, _VT], Iterable[Tuple[_KT, _VT]]],
        **kwargs: _VT
    ) -> None: ...
...
class KeyedRef(ref[_T], Generic[_KT, _T]):
    key: _KT
    def __new__(
        type, ob: _T, callback: Callable[[_T], Any], key: _KT
    ) -> KeyedRef: ...
    def __init__(
        self, ob: _T, callback: Callable[[_T], Any], key: _KT
    ) -> None: ...
...
class WeakKeyDictionary(MutableMapping[_KT, _VT]):
    ...
    @overload
    def __init__(
        self, dict: Union[Mapping[_KT, _VT], Iterable[Tuple[_KT, _VT]]]
    ) -> None: ...
    def __len__(self) -> int: ...
    def __getitem__(self, k: _KT) -> _VT: ...
    def __setitem__(self, k: _KT, v: _VT) -> None: ...
...
if sys.version_info >= (3, 4):
    class finalize:
        ...
        def detach(
            self,
        ) -> Optional[Tuple[_S, _T, Tuple[Any, ...], Dict[str, Any]]]: ...
        def peek(
            self,
        ) -> Optional[Tuple[_S, _T, Tuple[Any, ...], Dict[str, Any]]]: ...
        alive: bool
