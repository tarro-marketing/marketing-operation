...
class SocketHandler(Handler):
    ...
    def makeSocket(
        self, timeout: float = ...
    ) -> SocketType: ...  # timeout is undocumented
...
class SysLogHandler(Handler):
    ...
    def __init__(
        ...
        facility: int = ...,
        socktype: Optional[SocketKind] = ...,
    ) -> None: ...
    def encodePriority(
        self, facility: Union[int, str], priority: Union[int, str]
    ) -> int: ...
    def mapPriority(self, levelName: str) -> str: ...

class NTEventLogHandler(Handler):
    def __init__(
        self, appname: str, dllname: Optional[str] = ..., logtype: str = ...
    ) -> None: ...
...
if sys.version_info >= (3,):
    class QueueHandler(Handler):
        if sys.version_info >= (3, 7):
            def __init__(
                self, queue: Union[SimpleQueue[Any], Queue[Any]]
            ) -> None: ...
        else:
