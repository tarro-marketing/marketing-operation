...
if sys.version_info >= (3, 8):
    def addModuleCleanup(
        __function: Callable[..., Any], *args: Any, **kwargs: Any
    ) -> None: ...
...
class TestCase:
    ...
    def assertNotEqual(
        self, first: Any, second: Any, msg: Any = ...
    ) -> None: ...
    ...
    def assertIsInstance(
        self, obj: Any, cls: Union[type, Tuple[type, ...]], msg: Any = ...
    ) -> None: ...
    ...
    def assertNotAlmostEqual(
        self, first: float, second: float, *, msg: Any = ...
    ) -> None: ...
    @overload
    def assertNotAlmostEqual(
        self,
    ...
    def assertNotRegex(
        self,
        text: AnyStr,
        unexpected_regex: Union[AnyStr, Pattern[AnyStr]],
        msg: Any = ...,
    ) -> None: ...
    ...
    def addTypeEqualityFunc(
        self, typeobj: Type[Any], function: Callable[..., None]
    ) -> None: ...
    def assertMultiLineEqual(
        self, first: str, second: str, msg: Any = ...
    ) -> None: ...
    ...
    def assertListEqual(
        self, list1: List[Any], list2: List[Any], msg: Any = ...
    ) -> None: ...
    def assertTupleEqual(
        self, tuple1: Tuple[Any, ...], tuple2: Tuple[Any, ...], msg: Any = ...
    ) -> None: ...
    def assertSetEqual(
        self,
        set1: Union[Set[Any], FrozenSet[Any]],
        set2: Union[Set[Any], FrozenSet[Any]],
        msg: Any = ...,
    ) -> None: ...
    def assertDictEqual(
        self, d1: Dict[Any, Any], d2: Dict[Any, Any], msg: Any = ...
    ) -> None: ...
    ...
    if sys.version_info >= (3, 8):
        def addCleanup(
            self, __function: Callable[..., Any], *args: Any, **kwargs: Any
        ) -> None: ...
    else:
        def addCleanup(
    ...
    if sys.version_info >= (3, 8):
        @classmethod
        def addClassCleanup(
            cls, __function: Callable[..., Any], *args: Any, **kwargs: Any
        ) -> None: ...
        @classmethod
        def doClassCleanups(cls) -> None: ...

    def _formatMessage(
        self, msg: Optional[str], standardMsg: str
    ) -> str: ...  # undocumented
    ...
    def failUnlessRaises(
        self, exception: Union[Type[_E], Tuple[Type[_E], ...]], msg: Any = ...
    ) -> _AssertRaisesContext[_E]: ...
    def failUnlessAlmostEqual(
        self, first: float, second: float, places: int = ..., msg: Any = ...
    ) -> None: ...
