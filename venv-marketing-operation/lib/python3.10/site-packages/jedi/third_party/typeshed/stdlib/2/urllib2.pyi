...
class Request(object):
    ...
    def get_header(
        self, header_name: str, default: Optional[str] = ...
    ) -> str: ...
...
def build_opener(
    *handlers: Union[BaseHandler, Type[BaseHandler]]
) -> OpenerDirector: ...
...
class HTTPPasswordMgr:
    ...
    def add_password(
        self,
        realm: Optional[Text],
        uri: Union[Text, Sequence[Text]],
        user: Text,
        passwd: Text,
    ) -> None: ...
    def find_user_password(
        self, realm: Optional[Text], authuri: Text
    ) -> Tuple[Any, Any]: ...
    def reduce_uri(
        self, uri: _string, default_port: bool = ...
    ) -> Tuple[Any, Any]: ...
...
class AbstractBasicAuthHandler:
    def __init__(
        self, password_mgr: Optional[HTTPPasswordMgr] = ...
    ) -> None: ...
    def add_password(
        self,
        realm: Optional[Text],
...
class AbstractDigestAuthHandler:
    ...
    def get_entity_digest(
        self, data: Optional[bytes], chal: Mapping[str, str]
    ) -> Optional[str]: ...
...
class HTTPSHandler(AbstractHTTPHandler):
    def __init__(
        self, debuglevel: int = ..., context: Optional[ssl.SSLContext] = ...
    ) -> None: ...
