...
class UserDict(MutableMapping[_KT, _VT]):
    data: Dict[_KT, _VT]
    def __init__(
        self, __dict: Optional[Mapping[_KT, _VT]] = ..., **kwargs: _VT
    ) -> None: ...
    ...
    @classmethod
    def fromkeys(
        cls: Type[_S], iterable: Iterable[_KT], value: Optional[_VT] = ...
    ) -> _S: ...
...
class UserString(Sequence[str]):
    ...
    def count(
        self, sub: Union[str, UserString], start: int = ..., end: int = ...
    ) -> int: ...
    ...
    def lstrip(
        self: _UserStringT, chars: Optional[str] = ...
    ) -> _UserStringT: ...
    @staticmethod
    @overload
    def maketrans(
        x: Union[Dict[int, _T], Dict[str, _T], Dict[Union[str, int], _T]]
    ) -> Dict[int, _T]: ...
    @staticmethod
    @overload
    def maketrans(
    ...
    if sys.version_info >= (3, 9):
        def removeprefix(
            self: _UserStringT, __prefix: Union[str, UserString]
        ) -> _UserStringT: ...
        def removesuffix(
            self: _UserStringT, __suffix: Union[str, UserString]
        ) -> _UserStringT: ...
...
class Counter(Dict[_T, int], Generic[_T]):
    ...
    @overload
    def update(
        self, __m: Union[Iterable[_T], Iterable[Tuple[_T, int]]], **kwargs: int
    ) -> None: ...
    @overload
...
class defaultdict(Dict[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(
        self, default_factory: Optional[Callable[[], _VT]]
    ) -> None: ...
    @overload
    def __init__(
