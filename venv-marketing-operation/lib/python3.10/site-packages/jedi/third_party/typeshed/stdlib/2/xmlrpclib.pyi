...
def escape(
    s: AnyStr, replace: Callable[[AnyStr, AnyStr, AnyStr], AnyStr] = ...
) -> AnyStr: ...
...
class ProtocolError(Error):
    ...
    headers: Any
    def __init__(
        self, url: str, errcode: int, errmsg: str, headers: Any
    ) -> None: ...
...
class Fault(Error):
    ...
    faultString: str
    def __init__(
        self, faultCode: Any, faultString: str, **extra: Any
    ) -> None: ...
...
class DateTime:
    ...
    def __init__(
        self,
        value: Union[
            str, unicode, datetime, float, int, _timeTuple, struct_time
        ] = ...,
    ) -> None: ...
    def make_comparable(
        self, other: _dateTimeComp
...
class Marshaller:
    ...
    allow_none: bool
    def __init__(
        self, encoding: Optional[str] = ..., allow_none: bool = ...
    ) -> None: ...
    dispatch: Mapping[
        type, Callable[[Marshaller, str, Callable[[str], None]], None]
    ]
    def dumps(
        self,
        values: Union[
    ...
    def dump_double(
        self, value: float, write: Callable[[str], None]
    ) -> None: ...
    def dump_string(
        self,
        value: str,
        ...
        escape: Callable[
            [AnyStr, Callable[[AnyStr, AnyStr, AnyStr], AnyStr]], AnyStr
        ] = ...,
    ) -> None: ...
    def dump_unicode(
        self,
    ...
    def dump_array(
        self, value: Iterable[Any], write: Callable[[str], None]
    ) -> None: ...
    def dump_struct(
        self,
    ...
    def dump_datetime(
        self, value: datetime, write: Callable[[str], None]
    ) -> None: ...
    def dump_instance(
        self, value: InstanceType, write: Callable[[str], None]
    ) -> None: ...
...
class Unmarshaller:
    ...
    def end(
        self, tag: str, join: Callable[[Iterable[str], str], str] = ...
    ) -> None: ...
...
class _MultiCallMethod:
    def __init__(
        self, call_list: List[Tuple[str, Tuple[Any, ...]]], name: str
    ) -> None: ...
...
class _Method:
    def __init__(
        self, send: Callable[[str, Tuple[Any, ...]], Any], name: str
    ) -> None: ...
