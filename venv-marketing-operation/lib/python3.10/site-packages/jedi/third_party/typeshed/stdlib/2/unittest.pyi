...
class TestCase(Testable):
    ...
    def assertSetEqual(
        self,
        first: Union[Set[Any], FrozenSet[Any]],
        second: Union[Set[Any], FrozenSet[Any]],
        msg: object = ...,
    ) -> None: ...
    def assertDictEqual(
    ...
    @overload
    def assertRaisesRegexp(
        self, exception: _ExceptionType, regexp: _Regexp
    ) -> _AssertRaisesContext: ...
    def assertRegexpMatches(
        self, text: Text, regexp: _Regexp, msg: object = ...
    ) -> None: ...
    def assertNotRegexpMatches(
        self, text: Text, regexp: _Regexp, msg: object = ...
    ) -> None: ...
    def assertItemsEqual(
        self, first: Iterable[Any], second: Iterable[Any], msg: object = ...
    ) -> None: ...
    ...
    def addTypeEqualityFunc(
        self, typeobj: type, function: Callable[..., None]
    ) -> None: ...
    @overload
    ...
    def assertIsInstance(
        self, obj: Any, cls: Union[type, Tuple[type, ...]], msg: object = ...
    ) -> None: ...
    ...
    def _formatMessage(
        self, msg: Optional[Text], standardMsg: Text
    ) -> str: ...  # undocumented
...
class TestLoader:
    ...
    def loadTestsFromTestCase(
        self, testCaseClass: Type[TestCase]
    ) -> TestSuite: ...
    def loadTestsFromModule(
        self, module: types.ModuleType = ..., use_load_tests: bool = ...
    ) -> TestSuite: ...
    def loadTestsFromName(
        self, name: str = ..., module: Optional[types.ModuleType] = ...
    ) -> TestSuite: ...
    def loadTestsFromNames(
        self, names: List[str] = ..., module: Optional[types.ModuleType] = ...
    ) -> TestSuite: ...
    def discover(
        self,
        start_dir: str,
...
class TextTestResult(TestResult):
    ...
    def printErrorList(
        self, flavour: str, errors: List[Tuple[TestCase, str]]
    ) -> None: ...  # undocumented
...
def load_tests(
    loader: TestLoader, tests: TestSuite, pattern: Optional[Text]
) -> TestSuite: ...
