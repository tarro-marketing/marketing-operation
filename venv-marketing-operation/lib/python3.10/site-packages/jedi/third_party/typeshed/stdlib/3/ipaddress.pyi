...
def ip_address(
    address: object,
) -> Any: ...  # morally Union[IPv4Address, IPv6Address]
def ip_network(
    address: object, strict: bool = ...
) -> Any: ...  # morally Union[IPv4Network, IPv6Network]
def ip_interface(
    address: object,
) -> Any: ...  # morally Union[IPv4Interface, IPv6Interface]
...
class _BaseNetwork(_IPAddressBase, Container[_A], Iterable[_A], Generic[_A]):
    ...
    def subnets(
        self: _T, prefixlen_diff: int = ..., new_prefix: Optional[int] = ...
    ) -> Iterator[_T]: ...
    def supernet(
        self: _T, prefixlen_diff: int = ..., new_prefix: Optional[int] = ...
    ) -> _T: ...
