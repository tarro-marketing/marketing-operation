...
if sys.version_info >= (3,):
    class mmap(_mmap[bytes], ContextManager[mmap], Iterable[bytes], Sized):
        ...
        if sys.version_info >= (3, 8) and sys.platform != "win32":
            def madvise(
                self, option: int, start: int = ..., length: int = ...
            ) -> None: ...

        def find(
            self, sub: ReadableBuffer, start: int = ..., stop: int = ...
        ) -> int: ...
        def rfind(
            self, sub: ReadableBuffer, start: int = ..., stop: int = ...
        ) -> int: ...
    ...
    class mmap(_mmap[bytes], Sequence[bytes]):
        def find(
            self, string: bytes, start: int = ..., end: int = ...
        ) -> int: ...
        def rfind(
            self, string: bytes, start: int = ..., stop: int = ...
        ) -> int: ...
        ...
        def __delitem__(self, index: Union[int, slice]) -> None: ...
        def __setitem__(
            self, index: Union[int, slice], object: bytes
        ) -> None: ...
