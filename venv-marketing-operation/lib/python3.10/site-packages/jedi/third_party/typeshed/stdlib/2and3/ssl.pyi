...
class SSLSocket(socket.socket):
    ...
    def read(
        self, len: int = ..., buffer: Optional[bytearray] = ...
    ) -> bytes: ...
    def write(self, data: bytes) -> int: ...
    def do_handshake(
        self, block: bool = ...
    ) -> None: ...  # block is undocumented
    @overload
    def getpeercert(
...
class SSLContext:
    ...
    if sys.version_info >= (3, 7):
        def set_servername_callback(
            self, server_name_callback: Optional[_SrvnmeCbType]
        ) -> None: ...
    else:
        def set_servername_callback(
            self, __method: Optional[_SrvnmeCbType]
        ) -> None: ...
