...
class partialmethod(Generic[_T]):
    ...
    @overload
    def __init__(
        self, __func: _Descriptor, *args: Any, **keywords: Any
    ) -> None: ...
...
if sys.version_info >= (3, 8):
    class singledispatchmethod(Generic[_T]):
        ...
        @overload
        def register(
            self, cls: Any, method: None = ...
        ) -> Callable[[Callable[..., _T]], Callable[..., _T]]: ...
        @overload
        def register(
            self, cls: Any, method: Callable[..., _T]
        ) -> Callable[..., _T]: ...
        def __call__(self, *args: Any, **kwargs: Any) -> _T: ...
    ...
    class cached_property(Generic[_T]):
        ...
        @overload
        def __get__(
            self, instance: _S, owner: Optional[Type[Any]] = ...
        ) -> _T: ...
