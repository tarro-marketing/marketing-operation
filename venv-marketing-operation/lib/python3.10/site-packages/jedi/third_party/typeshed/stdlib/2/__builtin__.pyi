...
class int:
    ...
    def __new__(
        cls: Type[_T],
        x: Union[
            Text, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc
        ] = ...,
    ) -> _T: ...
    @overload
    def __new__(
        cls: Type[_T], x: Union[Text, bytes, bytearray], base: int
    ) -> _T: ...
    @property
    def real(self) -> int: ...
    @property
...
class float:
    def __new__(
        cls: Type[_T],
        x: Union[SupportsFloat, _SupportsIndex, Text, bytes, bytearray] = ...,
    ) -> _T: ...
...
class unicode(basestring, Sequence[unicode]):
    ...
    def decode(
        self, encoding: unicode = ..., errors: unicode = ...
    ) -> unicode: ...
    def encode(
        self, encoding: unicode = ..., errors: unicode = ...
    ) -> str: ...
    ...
    def replace(
        self, old: unicode, new: unicode, count: int = ...
    ) -> unicode: ...
    def rfind(self, sub: unicode, start: int = ..., end: int = ...) -> int: ...
    def rindex(
        self, sub: unicode, start: int = ..., end: int = ...
    ) -> int: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def find(
        self, __sub: str, __start: int = ..., __end: int = ...
    ) -> int: ...
    def index(
        self, __sub: str, __start: int = ..., __end: int = ...
    ) -> int: ...
    ...
    def rfind(
        self, __sub: bytes, __start: int = ..., __end: int = ...
    ) -> int: ...
    def rindex(
        self, __sub: bytes, __start: int = ..., __end: int = ...
    ) -> int: ...
...
class set(MutableSet[_T], Generic[_T]):
    ...
    def __isub__(
        self: Set[str], s: AbstractSet[Optional[Text]]
    ) -> Set[_T]: ...
    @overload
...
@overload
def reduce(
    __function: Callable[[_T, _S], _T],
    __iterable: Iterable[_S],
    __initializer: _T,
) -> _T: ...
@overload
def reduce(
    __function: Callable[[_T, _T], _T], __iterable: Iterable[_T]
) -> _T: ...
