...
_ButtonCommand = Union[
    str, Callable[[], Any]
]  # return value is returned from Button.invoke()
...
_XYScrollCommand = Union[
    str, Callable[[float, float], Any]
]  # -xscrollcommand and -yscrollcommand in 'options' manual page
_TakeFocusValue = Union[
    int, Literal[""], Callable[[str], Optional[bool]]
...
class Variable:
    ...
    def get(self) -> Any: ...
    def trace_add(
        self, mode: _TraceMode, callback: Callable[[str, str, str], Any]
    ) -> str: ...
...
class Misc:
    ...
    def bind(
        ...
        func: Optional[
            Callable[[Event[Misc]], Optional[Literal["break"]]]
        ] = ...,
        add: Optional[bool] = ...,
    ) -> str: ...
    @overload
    def bind(
        self, sequence: Optional[str], func: str, add: Optional[bool] = ...
    ) -> None: ...
    @overload
    ...
    @overload
    def bind_class(
        self, className: str, *, func: str, add: Optional[bool] = ...
    ) -> None: ...
    ...
    @overload
    def grid_bbox(
        self, column: int, row: int, col2: None = ..., row2: None = ...
    ) -> Optional[Tuple[int, int, int, int]]: ...
    @overload
    def grid_bbox(
    ...
    def grid_location(
        self, x: _ScreenUnits, y: _ScreenUnits
    ) -> Tuple[int, int]: ...
    @overload
    ...
    def grid_slaves(
        self, row: Optional[int] = ..., column: Optional[int] = ...
    ) -> List[Widget]: ...
...
class Wm:
    ...
    group: Any
    def wm_iconbitmap(
        self, bitmap: Optional[Any] = ..., default: Optional[Any] = ...
    ): ...
    iconbitmap: Any
    def wm_iconify(self): ...
    iconify: Any
    ...
    iconphoto: Any
    def wm_iconposition(
        self, x: Optional[Any] = ..., y: Optional[Any] = ...
    ): ...
    iconposition: Any
    ...
    manage: Any
    def wm_maxsize(
        self, width: Optional[Any] = ..., height: Optional[Any] = ...
    ): ...
    maxsize: Any
    def wm_minsize(
        self, width: Optional[Any] = ..., height: Optional[Any] = ...
    ...
    positionfrom: Any
    def wm_protocol(
        self, name: Optional[Any] = ..., func: Optional[Any] = ...
    ): ...
    protocol: Any
    def wm_resizable(
        self, width: Optional[Any] = ..., height: Optional[Any] = ...
...
class Pack:
    ...
    def pack_info(
        self,
    ) -> _PackInfo: ...  # errors if widget hasn't been packed
    pack = pack_configure
    forget = pack_forget
...
class _GridInfo(_InMiscNonTotal):  # empty dict if widget hasn't been gridded
    ...
    pady: Union[int, Tuple[int, int]]
    sticky: (
        str  # consists of letters 'n', 's', 'w', 'e', no repeats, may be empty
    )
...
class Widget(BaseWidget, Pack, Place, Grid):
    ...
    def bind(
        ...
        sequence: Optional[str] = ...,
        func: Optional[
            Callable[[Event[_W]], Optional[Literal["break"]]]
        ] = ...,
        add: Optional[bool] = ...,
    ) -> str: ...
    @overload
...
class Canvas(Widget, XView, YView):
    ...
    def tag_bind(
        ...
        sequence: Optional[str] = ...,
        func: Optional[
            Callable[[Event[Canvas]], Optional[Literal["break"]]]
        ] = ...,
        add: Optional[bool] = ...,
    ) -> str: ...
    @overload
    ...
    @overload
    def tag_bind(
        self, tagOrId: Union[str, int], *, func: str, add: Optional[bool] = ...
    ) -> None: ...
    def tag_unbind(
        self,
        tagOrId: Union[str, int],
    ...
    def find_closest(
        self, x, y, halo: Optional[Any] = ..., start: Optional[Any] = ...
    ): ...
    ...
    if sys.version_info >= (3, 8):
        def moveto(
            self, tagOrId: Union[int, str], x: str = ..., y: str = ...
        ) -> None: ...
...
class Checkbutton(Widget):
    ...
    @overload
    def configure(
        self, cnf: _CheckbuttonOptionName
    ) -> Tuple[str, str, str, Any, Any]: ...
    config = configure
...
class Menubutton(Widget):
    ...
    @overload
    def configure(
        self, cnf: _MenubuttonOptionName
    ) -> Tuple[str, str, str, Any, Any]: ...
    config = configure
...
class Radiobutton(Widget):
    ...
    @overload
    def configure(
        self, cnf: _RadiobuttonOptionName
    ) -> Tuple[str, str, str, Any, Any]: ...
    config = configure
...
class Scrollbar(Widget):
    def __init__(
        ...
        *,
        ...
        command: Union[
            Callable[..., Optional[Tuple[float, float]]], str
        ] = ...,
        cursor: _Cursor = ...,
...
class Text(Widget, XView, YView):
    def __init__(
        ...
        *,
        ...
        tabs: Union[
            _ScreenUnits, str, Tuple[Union[_ScreenUnits, str], ...]
        ] = ...,
    ...
    @overload
    def configure(
        self, cnf: _TextOptionName
    ) -> Tuple[str, str, str, Any, Any]: ...
    config = configure
    def cget(self, key: _TextOptionName) -> Any: ...
    def bbox(
        self, index: _TextIndex
    ) -> Optional[Tuple[int, int, int, int]]: ...
    def compare(
        self,
        index1: _TextIndex,
    ...
    def insert(
        ...
        index: _TextIndex,
        chars: str,
        *args: Union[_TextIndex, str, _TkinterSequence[str]],
    ) -> None: ...
    @overload
    def mark_gravity(
        self, markName: str, direction: None = ...
    ) -> Literal["left", "right"]: ...
    @overload
    def mark_gravity(
    ...
    def tag_add(
        self, tagName: str, index1: _TextIndex, *args: _TextIndex
    ) -> None: ...
    ...
    def tag_unbind(
        self, tagName: str, sequence: str, funcid: Optional[str] = ...
    ) -> None: ...
    ...
    def tag_lower(
        self, tagName: str, belowThis: Optional[str] = ...
    ) -> None: ...
    def tag_names(
    ...
    def tag_raise(
        self, tagName: str, aboveThis: Optional[str] = ...
    ) -> None: ...
...
class LabelFrame(Widget):
    ...
    @overload
    def configure(
        self, cnf: _LabelFrameOptionName
    ) -> Tuple[str, str, str, Any, Any]: ...
    config = configure
...
class PanedWindow(Widget):
    ...
    @overload
    def configure(
        self, cnf: _PanedWindowOptionName
    ) -> Tuple[str, str, str, Any, Any]: ...
    config = configure
