...
class _CData(metaclass=_CDataMeta):
    ...
    @classmethod
    def from_buffer(
        cls: Type[_CT], source: _WritableBuffer, offset: int = ...
    ) -> _CT: ...
    @classmethod
    def from_buffer_copy(
        cls: Type[_CT], source: _ReadOnlyBuffer, offset: int = ...
    ) -> _CT: ...
    @classmethod
...
_ECT = Callable[
    [Optional[Type[_CData]], _FuncPointer, Tuple[_CData, ...]], _CData
]
...
class _FuncPointer(_PointerLike, _CData):
    ...
    def __init__(
        self,
        func_spec: Tuple[_UnionT[str, int], CDLL],
...
def PYFUNCTYPE(
    restype: Optional[Type[_CData]], *argtypes: Type[_CData]
) -> Type[_FuncPointer]: ...
...
def cast(
    obj: _UnionT[_CData, _CArgObject, int], type: Type[_CastT]
) -> _CastT: ...
def create_string_buffer(
    init: _UnionT[int, bytes], size: Optional[int] = ...
) -> Array[c_char]: ...

c_buffer = create_string_buffer

def create_unicode_buffer(
    init: _UnionT[int, Text], size: Optional[int] = ...
) -> Array[c_wchar]: ...
...
if sys.platform == "win32":
    def WinError(
        code: Optional[int] = ..., descr: Optional[str] = ...
    ) -> OSError: ...
...
class _StructUnionMeta(_CDataMeta):
    _fields_: Sequence[
        _UnionT[Tuple[str, Type[_CData]], Tuple[str, Type[_CData], int]]
    ] = ...
    _pack_: int = ...
...
class Array(Generic[_CT], _CData):
    ...
    value: Any = (
        ...
    )  # Note: bytes if _CT == c_char, Text if _CT == c_wchar, unavailable otherwise
