...
class FTP:
    ...
    if sys.version_info >= (3, 3):
        ...
        def connect(
            self, host: Text = ..., port: int = ..., timeout: float = ...
        ) -> str: ...
    ...
    def retrlines(
        self, cmd: Text, callback: Optional[Callable[[str], Any]] = ...
    ) -> str: ...
    def storlines(
        self,
        cmd: Text,
    ...
    if sys.version_info >= (3, 3):
        def mlsd(
            self, path: Text = ..., facts: Iterable[str] = ...
