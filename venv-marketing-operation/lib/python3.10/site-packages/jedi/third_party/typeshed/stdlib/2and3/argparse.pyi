...
class _ActionsContainer:
    ...
    def register(
        self, registry_name: Text, value: Any, object: Any
    ) -> None: ...
    def _registry_get(
        self, registry_name: Text, value: Any, default: Any = ...
    ) -> Any: ...
    ...
    def _get_positional_kwargs(
        self, dest: Text, **kwargs: Any
    ) -> Dict[str, Any]: ...
    def _get_optional_kwargs(
        self, *args: Any, **kwargs: Any
    ) -> Dict[str, Any]: ...
    def _pop_action_class(
        self, kwargs: Any, default: Optional[Type[Action]] = ...
    ) -> Type[Action]: ...
    def _get_handler(
        self,
    ...
    def _handle_conflict_error(
        self,
        action: Action,
        conflicting_actions: Iterable[Tuple[Text, Action]],
    ) -> NoReturn: ...
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    def exit(
        self, status: int = ..., message: Optional[Text] = ...
    ) -> NoReturn: ...
    ...
    def _parse_known_args(
        self, arg_strings: List[Text], namespace: Namespace
    ) -> Tuple[Namespace, List[str]]: ...
    def _read_args_from_files(self, arg_strings: List[Text]) -> List[Text]: ...
    def _match_argument(
        self, action: Action, arg_strings_pattern: Text
    ) -> int: ...
    def _match_arguments_partial(
        self, actions: Sequence[Action], arg_strings_pattern: Text
    ) -> List[int]: ...
    def _parse_optional(
        self, arg_string: Text
    ) -> Optional[Tuple[Optional[Action], Text, Optional[Text]]]: ...
    def _get_option_tuples(
        self, option_string: Text
    ...
    def _print_message(
        self, message: str, file: Optional[IO[str]] = ...
    ) -> None: ...
...
class HelpFormatter:
    ...
    def _add_item(
        self, func: Callable[..., _Text], args: Iterable[Any]
    ) -> None: ...
    ...
    def _format_actions_usage(
        self, actions: Iterable[Action], groups: Iterable[_ArgumentGroup]
    ) -> _Text: ...
    ...
    def _metavar_formatter(
        self, action: Action, default_metavar: Text
...
class FileType:
    ...
    if sys.version_info >= (3,):
        ...
        def __init__(
            self, mode: Text = ..., bufsize: Optional[int] = ...
        ) -> None: ...
...
class _MutuallyExclusiveGroup(_ArgumentGroup):
    ...
    def __init__(
        self, container: _ActionsContainer, required: bool = ...
    ) -> None: ...
