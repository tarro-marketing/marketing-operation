...
class Element(MutableSequence[Element]):
    ...
    @overload
    def get(
        self, key: _str_argument_type, default: _T
    ...
    def iter(
        self, tag: Optional[_str_argument_type] = ...
    ...
    def set(
        self, __key: _str_argument_type, __value: _str_argument_type
    ) -> None: ...
...
def ProcessingInstruction(
    target: _str_argument_type, text: Optional[_str_argument_type] = ...
) -> Element: ...
...
class QName:
    ...
    def __init__(
        self,
        text_or_uri: _str_argument_type,
        tag: Optional[_str_argument_type] = ...,
    ) -> None: ...
...
class ElementTree:
    def __init__(
        ...
        file: Optional[_file_or_filename] = ...,
    ) -> None: ...
    def getroot(self) -> Element: ...
    def parse(
        self, source: _file_or_filename, parser: Optional[XMLParser] = ...
    ) -> Element: ...
    def iter(
        self, tag: Optional[_str_argument_type] = ...
    ) -> Generator[Element, None, None]: ...
...
def register_namespace(
    prefix: _str_argument_type, uri: _str_argument_type
) -> None: ...
...
def parse(
    source: _file_or_filename, parser: Optional[XMLParser] = ...
) -> ElementTree: ...
def iterparse(
...
def XML(
    text: _parser_input_type, parser: Optional[XMLParser] = ...
) -> Element: ...
def XMLID(
    text: _parser_input_type, parser: Optional[XMLParser] = ...
...
def fromstringlist(
    sequence: Sequence[_parser_input_type], parser: Optional[XMLParser] = ...
) -> Element: ...
...
class TreeBuilder:
    def __init__(
        self, element_factory: Optional[_ElementFactory] = ...
    ) -> None: ...
...
class XMLParser:
    ...
    if sys.version_info >= (3, 8):
        def __init__(
            self, *, target: Any = ..., encoding: Optional[str] = ...
        ) -> None: ...
    else:
        def __init__(
            self,
        ...
        def doctype(
            self, __name: str, __pubid: str, __system: str
        ) -> None: ...
