...
class SocketType(object):
    ...
    def getsockopt(
        self, level: int, option: int, buffersize: int = ...
    ) -> str: ...
    ...
    @overload
    def sendto(
        self, data: str, flags: int, address: Tuple[Any, ...]
    ) -> int: ...
    def setblocking(self, flag: bool) -> None: ...
    def setsockopt(
        self, level: int, option: int, value: Union[int, str]
    ) -> None: ...
