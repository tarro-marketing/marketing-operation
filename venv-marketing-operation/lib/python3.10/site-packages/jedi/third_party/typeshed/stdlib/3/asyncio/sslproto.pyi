...
class _SSLPipe:
    ...
    def do_handshake(
        self,
        callback: Optional[Callable[[Optional[BaseException]], None]] = ...,
    ) -> List[bytes]: ...
    def shutdown(
    ...
    def feed_ssldata(
        self, data: bytes, only_handshake: bool = ...
...
class _SSLProtocolTransport(
    transports._FlowControlMixin, transports.Transport
):
    ...
    def get_extra_info(
        self, name: str, default: Optional[Any] = ...
    ) -> Dict[str, Any]: ...
...
class SSLProtocol(protocols.Protocol):
    ...
    if sys.version_info >= (3, 7):
        def _set_app_protocol(
            self, app_protocol: protocols.BaseProtocol
        ) -> None: ...
    ...
    def _on_handshake_complete(
        self, handshake_exc: Optional[BaseException]
    ) -> None: ...
