...
class int:
    ...
    def __new__(
        cls: Type[_T],
        x: Union[
            str, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc
        ] = ...,
    ) -> _T: ...
    @overload
    def __new__(
        cls: Type[_T], x: Union[str, bytes, bytearray], base: int
    ) -> _T: ...
    @overload
    def __init__(
        self,
    ...
    @overload
    def __pow__(
        self, __x: Literal[2], __modulo: Optional[int] = ...
    ) -> int: ...
    @overload
    def __pow__(
...
class float:
    def __new__(
        cls: Type[_T],
        x: Union[SupportsFloat, _SupportsIndex, str, bytes, bytearray] = ...,
    ) -> _T: ...
    ...
    def __pow__(
        ...
        float
    ): ...  # In Python 3, returns complex if self is negative and x is not whole
...
class complex:
    ...
    @overload
    def __new__(
        cls: Type[_T], real: Union[str, SupportsComplex, _SupportsIndex]
    ) -> _T: ...
    @property
    def real(self) -> float: ...
    @property
...
class str(Sequence[str]):
    ...
    def count(
        self, x: str, __start: Optional[int] = ..., __end: Optional[int] = ...
    ) -> int: ...
    ...
    def translate(
        self,
        __table: Union[
            Mapping[int, Union[int, str, None]],
...
class bytes(ByteString):
    ...
    @overload
    def __new__(
        cls: Type[_T], string: str, encoding: str, errors: str = ...
    ) -> _T: ...
    @overload
    ...
    def replace(
        self, __old: bytes, __new: bytes, __count: int = ...
    ) -> bytes: ...
    if sys.version_info >= (3, 9):
...
class bytearray(MutableSequence[int], ByteString):
    ...
    @overload
    def __init__(
        self, string: str, encoding: str, errors: str = ...
    ) -> None: ...
    @overload
    ...
    @overload
    def __setitem__(
        self, s: slice, x: Union[Iterable[int], bytes]
    ) -> None: ...
...
class memoryview(Sized, Container[int]):
    ...
    if sys.version_info >= (3, 8):
        def tobytes(
            self, order: Optional[Literal["C", "F", "A"]] = ...
        ) -> bytes: ...
    else:
...
class tuple(Sequence[_T_co], Generic[_T_co]):
    ...
    def index(
        self, __value: Any, __start: int = ..., __stop: int = ...
    ) -> int: ...
    if sys.version_info >= (3, 9):
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    def index(
        self, __value: _T, __start: int = ..., __stop: int = ...
    ) -> int: ...
...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(
        self, iterable: Iterable[Tuple[_KT, _VT]], **kwargs: _VT
    ) -> None: ...
    ...
    @overload
    def fromkeys(
        cls, __iterable: Iterable[_T], __value: _S
    ) -> Dict[_T, _S]: ...
    def __len__(self) -> int: ...
...
def format(
    __value: object, __format_spec: str = ...
) -> str: ...  # TODO unicode
...
@overload
def iter(
    __function: Callable[[], Optional[_T]], __sentinel: None
) -> Iterator[_T]: ...
@overload
...
@overload
def map(
    __func: Callable[[_T1], _S], __iter1: Iterable[_T1]
) -> Iterator[_S]: ...
@overload
def map(
...
@overload
def max(
    __arg1: _T, __arg2: _T, *_args: _T, key: Callable[[_T], SupportsLessThanT]
) -> _T: ...
@overload
def max(
...
@overload
def max(
    __iterable: Iterable[_T], *, key: Callable[[_T], SupportsLessThanT]
) -> _T: ...
@overload
def max(
...
def max(
    ...
    *,
    key: Callable[[_T1], SupportsLessThanT],
    default: _T2,
) -> Union[_T1, _T2]: ...
@overload
def min(
...
if sys.version_info >= (3, 8):
    ...
    def pow(
        ...
        Any
    ): ...  # returns int or float depending on whether exp is non-negative
    @overload
    ...
    @overload
    def pow(
        __base: _SupportsPow3[_E, _M, _T_co], __exp: _E, __mod: _M
    ) -> _T_co: ...
...
@overload
def sorted(
    __iterable: Iterable[SupportsLessThanT],
    *,
    key: None = ...,
    reverse: bool = ...,
