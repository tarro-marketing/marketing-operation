...
class Fault(Error):
    ...
    faultString: str
    def __init__(
        self, faultCode: str, faultString: str, **extra: Any
    ) -> None: ...
...
class Marshaller:
    ...
    def __dump(
        self, value: Union[_Marshallable], write: Callable[[str], Any]
    ) -> None: ...  # undocumented
    ...
    def dump_double(
        self, value: float, write: Callable[[str], Any]
    ) -> None: ...
    def dump_unicode(
        self,
        value: str,
    ...
    def dump_bytes(
        self, value: bytes, write: Callable[[str], Any]
    ) -> None: ...
    def dump_array(
        self, value: Iterable[_Marshallable], write: Callable[[str], Any]
    ) -> None: ...
    def dump_struct(
        self,
    ...
    def dump_datetime(
        self, value: _XMLDate, write: Callable[[str], Any]
    ) -> None: ...
    def dump_instance(
        self, value: object, write: Callable[[str], Any]
    ) -> None: ...
...
class Unmarshaller:
    ...
    def __init__(
        self, use_datetime: bool = ..., use_builtin_types: bool = ...
    ) -> None: ...
    def close(self) -> Tuple[_Marshallable, ...]: ...
    def getmethodname(self) -> Optional[str]: ...
    def xml(
        self, encoding: str, standalone: Any
    ) -> None: ...  # Standalone is ignored
...
def getparser(
    use_datetime: bool = ..., use_builtin_types: bool = ...
...
class _Method:  # undocumented
    ...
    def __init__(
        self,
        send: Callable[[str, Tuple[_Marshallable, ...]], _Marshallable],
        name: str,
    ) -> None: ...
...
class Transport:
    ...
    _use_builtin_types: bool
    _connection: Tuple[
        Optional[_HostType], Optional[http.client.HTTPConnection]
    ]
    ...
    def close(self) -> None: ...
    def send_request(
        self, host: _HostType, handler: str, request_body: bytes, debug: bool
    ) -> http.client.HTTPConnection: ...
    def send_headers(
        self,
    ...
    def send_content(
        self, connection: http.client.HTTPConnection, request_body: bytes
    ) -> None: ...
    def parse_response(
