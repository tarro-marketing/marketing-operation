...
def get_default_compiler(
    osname: Optional[str] = ..., platform: Optional[str] = ...
) -> str: ...
def new_compiler(
    plat: Optional[str] = ...,
...
class CCompiler:
    ...
    objects: List[str]
    def __init__(
        self, verbose: int = ..., dry_run: int = ..., force: int = ...
    ) -> None: ...
    ...
    def find_library_file(
        self, dirs: List[str], lib: str, debug: bool = ...
    ) -> Optional[str]: ...
    def has_function(
        self,
        funcname: str,
    ...
    def executable_filename(
        self, basename: str, strip_dir: int = ..., output_dir: str = ...
    ) -> str: ...
