...
class InterpolationMissingOptionError(InterpolationError):
    reference: str
    def __init__(
        self, option: str, section: str, rawval: str, reference: str
    ) -> None: ...
...
class RawConfigParser:
    ...
    def readfp(
        self, fp: SupportsNoArgReadline[str], filename: str = ...
    ) -> None: ...
...
class ConfigParser(RawConfigParser):
    ...
    def _interpolate(
        self, section: str, option: str, rawval: Any, vars: Any
    ) -> str: ...
