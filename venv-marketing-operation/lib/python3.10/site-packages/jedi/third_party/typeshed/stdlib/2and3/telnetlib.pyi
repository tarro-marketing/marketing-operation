...
class Telnet:
    def __init__(
        self, host: Optional[str] = ..., port: int = ..., timeout: int = ...
    ) -> None: ...
    ...
    def read_until(
        self, match: bytes, timeout: Optional[int] = ...
    ) -> bytes: ...
    ...
    def set_option_negotiation_callback(
        self, callback: Optional[Callable[[socket.socket, bytes, bytes], Any]]
    ) -> None: ...
    ...
    def expect(
        self,
        list: Sequence[Union[Pattern[bytes], bytes]],
