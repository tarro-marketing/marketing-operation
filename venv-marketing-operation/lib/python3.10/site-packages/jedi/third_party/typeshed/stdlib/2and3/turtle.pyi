...
class Shape(object):
    def __init__(
        self, type_: str, data: Union[_PolygonCoords, PhotoImage, None] = ...
    ) -> None: ...
    def addcomponent(
        self,
        poly: _PolygonCoords,
        fill: _Color,
        outline: Optional[_Color] = ...,
    ) -> None: ...
...
class TurtleScreen(TurtleScreenBase):
    ...
    def register_shape(
        self, name: str, shape: Union[_PolygonCoords, Shape, None] = ...
    ) -> None: ...
    @overload
    ...
    def onclick(
        self,
        fun: Callable[[float, float], Any],
        btn: int = ...,
        add: Optional[Any] = ...,
    ) -> None: ...
    def onkey(self, fun: Callable[[], Any], key: str) -> None: ...
    def listen(
        self, xdummy: Optional[float] = ..., ydummy: Optional[float] = ...
    ) -> None: ...
    ...
    @overload
    def screensize(
        self, canvwidth: int, canvheight: int, bg: Optional[_Color] = ...
    ) -> None: ...
    ...
    if sys.version_info >= (3,):
        def onkeypress(
            self, fun: Callable[[], Any], key: Optional[str] = ...
        ) -> None: ...
        onkeyrelease = onkey
...
class TNavigator(object):
    ...
    @overload
    def distance(
        self, x: Union[TNavigator, Tuple[float, float]], y: None = ...
    ) -> float: ...
    @overload
...
class RawTurtle(TPen, TNavigator):
    def __init__(
        self,
        canvas: Union[Canvas, TurtleScreen, None] = ...,
        shape: str = ...,
        undobuffersize: int = ...,
        visible: bool = ...,
    ) -> None: ...
    ...
    def shapesize(
        self,
        stretch_wid: Optional[float] = ...,
        stretch_len: Optional[float] = ...,
        outline: Optional[float] = ...,
    ) -> None: ...
    if sys.version_info >= (3,):
        @overload
...
def register_shape(
    name: str, shape: Union[_PolygonCoords, Shape, None] = ...
) -> None: ...
@overload
...
def listen(
    xdummy: Optional[float] = ..., ydummy: Optional[float] = ...
) -> None: ...
...
@overload
def screensize(
    canvwidth: int, canvheight: int, bg: Optional[_Color] = ...
) -> None: ...
...
if sys.version_info >= (3,):
    def onkeypress(
        fun: Callable[[], Any], key: Optional[str] = ...
    ) -> None: ...
    onkeyrelease = onkey
...
@overload
def distance(
    x: Union[TNavigator, Tuple[float, float]], y: None = ...
) -> float: ...
@overload
...
def circle(
    radius: float, extent: Optional[float] = ..., steps: Optional[int] = ...
) -> None: ...
