...
class TarFile(Iterable[TarInfo]):
    ...
    if sys.version_info >= (3, 5):
        ...
        def extractall(
            self, path: AnyPath = ..., members: Optional[List[TarInfo]] = ...
        ) -> None: ...
    if sys.version_info >= (3, 5):
        def extract(
            self,
        ...
        def extract(
            self, member: Union[str, TarInfo], path: AnyPath = ...
        ) -> None: ...

    def extractfile(
        self, member: Union[str, TarInfo]
    ) -> Optional[IO[bytes]]: ...
    def makedir(
        self, tarinfo: TarInfo, targetpath: AnyPath
    ) -> None: ...  # undocumented
    def makefile(
        self, tarinfo: TarInfo, targetpath: AnyPath
    ) -> None: ...  # undocumented
    ...
    if sys.version_info >= (3, 5):
        def chown(
            self, tarinfo: TarInfo, targetpath: AnyPath, numeric_owner: bool
        ) -> None: ...  # undocumented
    else:
        def chown(
            self, tarinfo: TarInfo, targetpath: AnyPath
    ...
    def addfile(
        self, tarinfo: TarInfo, fileobj: Optional[IO[bytes]] = ...
    ) -> None: ...
    def gettarinfo(
        self,
        name: Optional[str] = ...,
...
if sys.version_info < (3,):
    class TarFileCompat:
        def __init__(
            self, filename: str, mode: str = ..., compression: int = ...
        ) -> None: ...
...
class TarInfo:
    ...
    if sys.version_info >= (3,):
        @classmethod
        def frombuf(
            cls, buf: bytes, encoding: str, errors: str
        ) -> TarInfo: ...
    else:
        @classmethod
