...
class Differ:
    ...
    def compare(
        self, a: Sequence[_StrType], b: Sequence[_StrType]
    ) -> Iterator[_StrType]: ...

def IS_LINE_JUNK(
    line: _StrType, pat: Any = ...
) -> bool: ...  # pat is undocumented
def IS_CHARACTER_JUNK(
    ch: _StrType, ws: _StrType = ...
) -> bool: ...  # ws is undocumented
def unified_diff(
    a: Sequence[_StrType],
    b: Sequence[_StrType],
    fromfile: _StrType = ...,
...
if sys.version_info >= (3, 5):
    def diff_bytes(
        dfunc: Callable[
            [Sequence[str], Sequence[str], str, str, str, str, int, str],
            Iterator[str],
        ],
        a: Sequence[bytes],
        b: Sequence[bytes],
