...
class Widget(tkinter.Widget):
    ...
    def instate(
        self, statespec, callback: Optional[Any] = ..., *args, **kw
    ): ...
...
_PanedwindowOptionName = Literal[
    "class", "cursor", "height", "orient", "style", "takefocus", "width"
]
...
class Progressbar(Widget):
    ...
    @overload
    def configure(
        self, cnf: _ProgressbarOptionName
    ) -> Tuple[str, str, str, Any, Any]: ...
    config = configure
    ...
    class Spinbox(Entry):
        def __init__(
            ...
            *,
            ...
            class_: str = ...,
            command: Union[
                Callable[[], Any], str, tkinter._TkinterSequence[str]
            ] = ...,
            cursor: tkinter._Cursor = ...,
...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    def __init__(
        ...
        *,
        ...
        cursor: tkinter._Cursor = ...,
        displaycolumns: Union[
            str,
            tkinter._TkinterSequence[str],
            tkinter._TkinterSequence[int],
            Literal["#all"],
        ] = ...,
        height: int = ...,
        name: str = ...,
    ...
    if sys.version_info >= (3, 8):
        ...
        def selection(
            self, selop: Optional[Any] = ..., items: Optional[Any] = ...
        ) -> List[Any]: ...
    ...
    def set(
        self, item, column: Optional[Any] = ..., value: Optional[Any] = ...
    ): ...
    ...
    def tag_bind(
        ...
        callback: Optional[
            Callable[[tkinter.Event[Treeview]], Optional[Literal["break"]]]
        ] = ...,
    ) -> str: ...
    @overload
    def tag_bind(
        self, tagname: str, sequence: Optional[str], callback: str
    ) -> None: ...
    @overload
