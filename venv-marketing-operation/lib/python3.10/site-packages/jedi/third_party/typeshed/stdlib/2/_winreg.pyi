...
def ConnectRegistry(
    __computer_name: Optional[str], __key: _KeyType
) -> HKEYType: ...
...
def DeleteKeyEx(
    key: _KeyType, sub_key: str, access: int = ..., reserved: int = ...
) -> None: ...
...
def OpenKey(
    key: _KeyType, sub_key: str, reserved: int = ..., access: int = ...
) -> HKEYType: ...
def OpenKeyEx(
    key: _KeyType, sub_key: str, reserved: int = ..., access: int = ...
) -> HKEYType: ...
...
def SetValueEx(
    __key: _KeyType,
    __value_name: Optional[str],
    __reserved: Any,
    __type: int,
    __value: Union[str, int],
