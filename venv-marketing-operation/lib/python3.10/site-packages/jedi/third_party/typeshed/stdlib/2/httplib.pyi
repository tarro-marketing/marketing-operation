...
class HTTPConnectionProtocol(Protocol):
    def __call__(
        self, host: str, timeout: int = ..., **http_con_args: Any
    ) -> HTTPConnection: ...
...
class HTTPConnection:
    ...
    def set_tunnel(
        self, host, port: Optional[Any] = ..., headers: Optional[Any] = ...
    ): ...
...
class HTTP:
    ...
    def connect(
        self, host: Optional[Any] = ..., port: Optional[Any] = ...
    ): ...
    def getfile(self): ...
    file: Any
    headers: Any
