...
class BaseContext(object):
    ...
    # how to handle the ctype
    def Value(
        self, typecode_or_type: Any, *args: Any, lock: bool = ...
    ) -> sharedctypes._Value: ...
    # TODO: typecode_or_type param is a ctype with a base class of _SimpleCData or array.typecode Need to figure out
    # how to handle the ctype
    def Array(
    ...
    if sys.platform != "win32":
        ...
        @overload
        def get_context(
            self, method: Literal["forkserver"]
        ) -> ForkServerContext: ...
        @overload
    ...
    def set_start_method(
        self, method: Optional[str], force: bool = ...
    ) -> None: ...
    @property
