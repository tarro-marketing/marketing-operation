...
if sys.version_info >= (3,):
    def copyfile(
        src: StrPath, dst: _AnyPath, *, follow_symlinks: bool = ...
    ) -> _AnyPath: ...
    def copymode(
...
if sys.version_info >= (3, 8):
    ...
    def copytree(
        ...
        symlinks: bool = ...,
        ignore: Union[
            None, Callable[[AnyStr, List[AnyStr]], Iterable[AnyStr]]
        ] = ...,
    ) -> _PathReturn: ...

if sys.version_info >= (3,):
    def rmtree(
        path: Union[bytes, StrPath],
        ignore_errors: bool = ...,
    ...
    def rmtree(
        path: _AnyPath,
        ignore_errors: bool = ...,
        onerror: Optional[Callable[[Any, _AnyPath, Any], Any]] = ...,
    ) -> None: ...
...
if sys.version_info >= (3, 9):
    ...
    def move(
        src: str, dst: StrPath, copy_function: _CopyFn = ...
    ) -> _PathReturn: ...
...
if sys.version_info >= (3, 8):
    @overload
    def which(
        cmd: StrPath, mode: int = ..., path: Optional[StrPath] = ...
    ) -> Optional[str]: ...
    @overload
    def which(
