...
)  # TODO: use this, see https://github.com/python/mypy/issues/3078
from typing import (
    IO,
    Any,
    AnyStr,
...
if sys.version_info >= (3, 0):
    def utime(
        path: AnyPath, times: Optional[Tuple[float, float]] = ...
    ) -> None: ...
...
def execl(
    file: AnyPath, __arg0: Union[bytes, Text], *args: Union[bytes, Text]
) -> NoReturn: ...
def execlp(
    file: AnyPath, __arg0: Union[bytes, Text], *args: Union[bytes, Text]
) -> NoReturn: ...
...
def execle(
    file: AnyPath, __arg0: Union[bytes, Text], *args: Any
) -> NoReturn: ...
def execlpe(
    file: AnyPath, __arg0: Union[bytes, Text], *args: Any
) -> NoReturn: ...
...
def execve(
    path: AnyPath, args: _ExecVArgs, env: Mapping[str, str]
) -> NoReturn: ...
def execvp(file: AnyPath, args: _ExecVArgs) -> NoReturn: ...
def execvpe(
    file: AnyPath, args: _ExecVArgs, env: Mapping[str, str]
) -> NoReturn: ...
...
if sys.version_info >= (3, 0):
    class popen(_TextIOWrapper):
        ...
        def __init__(
            self, command: str, mode: str = ..., bufsize: int = ...
        ) -> None: ...
...
def spawnl(
    mode: int,
    path: AnyPath,
    arg0: Union[bytes, Text],
    *args: Union[bytes, Text]
) -> int: ...
def spawnle(
    mode: int, path: AnyPath, arg0: Union[bytes, Text], *args: Any
) -> int: ...  # Imprecise sig
def spawnv(
    mode: int, path: AnyPath, args: List[Union[bytes, Text]]
) -> int: ...
def spawnve(
    mode: int,
    path: AnyPath,
    args: List[Union[bytes, Text]],
    env: Mapping[str, str],
) -> int: ...
...
if sys.platform == "win32":
    ...
    def spawnlpe(
        mode: int, file: AnyPath, arg0: Union[bytes, Text], *args: Any
    ) -> int: ...  # Imprecise signature
    def spawnvp(
        mode: int, file: AnyPath, args: List[Union[bytes, Text]]
    ) -> int: ...
    def spawnvpe(
        mode: int,
        file: AnyPath,
