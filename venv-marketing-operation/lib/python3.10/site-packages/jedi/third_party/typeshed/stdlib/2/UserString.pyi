...
class UserString(Sequence[UserString]):
    ...
    def decode(
        self: _UST, encoding: Optional[str] = ..., errors: Optional[str] = ...
    ) -> _UST: ...
    def encode(
        self: _UST, encoding: Optional[str] = ..., errors: Optional[str] = ...
    ) -> _UST: ...
    def endswith(
        self, suffix: Text, start: int = ..., end: int = ...
    ) -> bool: ...
    ...
    def replace(
        self: _UST, old: Text, new: Text, maxsplit: int = ...
    ) -> _UST: ...
    ...
    def split(
        self, sep: Optional[Text] = ..., maxsplit: int = ...
    ) -> List[Text]: ...
    def rsplit(
        self, sep: Optional[Text] = ..., maxsplit: int = ...
    ) -> List[Text]: ...
