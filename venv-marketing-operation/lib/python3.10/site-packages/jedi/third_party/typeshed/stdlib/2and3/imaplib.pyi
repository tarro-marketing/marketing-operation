...
class IMAP4:
    ...
    def append(
        self, mailbox: str, flags: str, date_time: str, message: str
    ) -> str: ...
    def authenticate(
        self, mechanism: str, authobject: Callable[[bytes], Optional[bytes]]
    ) -> Tuple[str, str]: ...
    ...
    def search(
        self, charset: Optional[str], *criteria: str
    ) -> _CommandResults: ...
    def select(
...
def Time2Internaldate(
    date_time: Union[float, time.struct_time, str]
) -> str: ...
