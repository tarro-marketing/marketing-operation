...
if sys.version_info >= (3, 8):
    ...
    _ExecArg = Union[
        str, bytes
    ]  # Union used instead of AnyStr due to mypy issue  #1236
...
class SubprocessStreamProtocol(
    streams.FlowControlMixin, protocols.SubprocessProtocol
):
    ...
    def pipe_connection_lost(
        self, fd: int, exc: Optional[Exception]
    ) -> None: ...
