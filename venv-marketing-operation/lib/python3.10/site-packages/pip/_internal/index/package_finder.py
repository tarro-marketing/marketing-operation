...
CandidateSortingKey = Tuple[int, int, int,
                            _BaseVersion, Optional[int], BuildTag]
...
class CandidateEvaluator:
    ...
    def get_applicable_candidates(
        ...
        applicable_candidates = [
            c for c, v in candidates_and_versions if v in versions]
...
def _extract_version_from_fragment(
        fragment: str,
        canonical_name: str) -> Optional[str]:
