...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # This holds the Distribution object if this requirement is already
        # installed.
    ...
    def is_pinned(self) -> bool:
        ...
        return len(specifiers) == 1 and next(
            iter(specifiers)).operator in {"==", "==="}
    ...
    def match_markers(
        ...
        if self.markers is not None:
            return any(self.markers.evaluate(
                {"extra": extra}) for extra in extras_requested)
        else:
            return True
