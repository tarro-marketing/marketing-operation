...
class VcsSupport:
    ...
    def get_backend_for_scheme(
            self, scheme: str) -> Optional["VersionControl"]:
        """
...
class VersionControl:
    ...
    def make_rev_options(
            cls,
            rev: Optional[str] = None,
            extra_args: Optional[CommandArgs] = None) -> RevOptions:
        """
    ...
    def get_url_rev_options(
            self, url: HiddenText) -> Tuple[HiddenText, RevOptions]:
        """
    ...
    def run_command(
        ...
        try:
            ...
            raise BadCommand(
                f"Cannot find command {cls.name!r} - invalid PATH")
