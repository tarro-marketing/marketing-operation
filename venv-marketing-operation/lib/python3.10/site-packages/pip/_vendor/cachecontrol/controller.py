...
class CacheController:
    ...
    def _load_from_cache(
            self,
            request: PreparedRequest) -> HTTPResponse | None:
        """
    ...
    def cached_request(
            self,
            request: PreparedRequest) -> HTTPResponse | Literal[False]:
        """
        ...
        # the cache.
            ...
            # in the meantime.
                ...
                if response_headers["expires"]:
                    ...
                    logger.debug(
                        "Caching b/c of expires header. expires in {} seconds".format(expires_time))
                    self._cache_set(
                        cache_url,
                        request,
                        response,
