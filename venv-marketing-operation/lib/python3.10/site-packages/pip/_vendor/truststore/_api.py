...
_PasswordType: typing.TypeAlias = str | bytes | typing.Callable[[
], str | bytes]
...
class SSLContext(_truststore_SSLContext_super_class):  # type: ignore[misc]
    ...
    @typing.overload
    def get_ca_certs(
        self, binary_form: typing.Literal[True] = ...) -> list[bytes]: ...

    @typing.overload
    def get_ca_certs(self, binary_form: bool = ...) -> typing.Any: ...

    def get_ca_certs(
            self, binary_form: bool = False) -> list[typing.Any] | list[bytes]:
        raise NotImplementedError()
...
if sys.version_info >= (3, 13):
    ...
    def _get_unverified_chain_bytes(sslobj: ssl.SSLObject) -> list[bytes]:
        # type: ignore[attr-defined]
        unverified_chain = sslobj.get_unverified_chain() or ()
        return [cert.public_bytes(_ssl.ENCODING_DER)
                for cert in unverified_chain]
