                ...
                for base in bases:
                    if not (
                        base in {
                            ...
                            typing.Generic,
                            Protocol,
                            typing.Protocol} or base.__name__ in _PROTO_ALLOWLIST.get(
                            base.__module__,
                            []) or is_protocol(base)):
                        raise TypeError(
...
if _PEP_728_IMPLEMENTED:
    ...
    # 3.10.0 and later
    _TAKES_MODULE = "module" in inspect.signature(
        typing._type_check).parameters
    ...
    class _TypedDictMeta(type):
        def __new__(cls, name, bases, ns, *, total=True, closed=False):
            ...
            if "__annotations__" in ns:
                ...
                # TODO: Use inspect.VALUE here, and make the annotations lazily
                # evaluated
    ...
    def TypedDict(typename, fields=_marker, /, *,
                  total=True, closed=False, **kwargs):
...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def _strip_extras(t):
        ...
        if hasattr(
                t,
                "__origin__") and t.__origin__ in (
                Required,
                NotRequired,
                ReadOnly):
    ...
    class TypeVar(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *constraints, bound=None,
            ...
            if hasattr(typing, "TypeAliasType"):
                # PEP 695 implemented (3.12+), can pass infer_variance to
                # typing.TypeVar
...
# 3.10+
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, bound=None,
            ...
            if hasattr(typing, "TypeAliasType"):
                # PEP 695 implemented, can pass infer_variance to
                # typing.TypeVar
...
if not hasattr(typing, 'Concatenate'):
    ...
    class _ConcatenateGenericAlias(list):
        ...
        def __parameters__(self):
            return tuple(
                tp for tp in self.__args__ if isinstance(
                    tp, (typing.TypeVar, ParamSpec)))
...
if sys.version_info >= (3, 12):  # 3.12+
    ...
    def dataclass_transform(*,
                            ...
                            field_specifiers: typing.Tuple[typing.Union[typing.Type[typing.Any],
                                                                        typing.Callable[...,
                                                                                        typing.Any]],
                                                           ...] = (),
                            **kwargs: typing.Any,
...
if not hasattr(typing, "TypeVarTuple"):
    def _check_generic(cls, parameters, elen=_marker):
        ...
        if alen != elen:
            ...
            things = "arguments" if sys.version_info >= (
                3, 10) else "parameters"
            raise TypeError(
        ...
        for t in types:
            if _is_unpacked_typevartuple(t):
                ...
                if enforce_default_ordering:
                    has_default = getattr(
                        t, '__default__', NoDefault) is not NoDefault
                    if has_default:
    ...
    def _make_nmtuple(name, types, module, defaults=()):
        ...
        annotations = {
            n: typing._type_check(
                t,
                f"field {n} annotation must be a type") for n,
            t in types}
        ...
        if fields is _marker:
            if kwargs:
                ...
                deprecation_msg = (
                    ...
                    "pass an empty list, e.g. ") + example + "."
        elif fields is None:
            if kwargs:
                raise TypeError(
