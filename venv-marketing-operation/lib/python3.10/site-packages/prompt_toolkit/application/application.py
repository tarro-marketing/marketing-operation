...
class Application(Generic[_AppResult]):
    ...
    def __init__(
        ...
        self._last_redraw_time = (
            0.0  # Unix timestamp of last redraw. Used when
        )
    ...
    async def run_async(
            ...
            with self.input.raw_mode(), self.input.attach(
                ...
                try:
                    ...
                    try:
                        ...
                        previous_run_in_terminal_f = (
                            self._running_in_terminal_f
                        )
        ...
        def create_future(
            ...
            self.future = (
                f  # XXX: make sure to set this before calling '_redraw'.
            )
    ...
    async def run_system_command(
        ...
        async with in_terminal():
            ...
            def run_command() -> None:
                ...
                p = Popen(
                    command, shell=True, stdin=input_fd, stdout=output_fd
                )
                p.wait()
...
def attach_winch_signal_handler(
    ...
    loop = get_running_loop()
    previous_winch_handler = getattr(loop, "_signal_handlers", {}).get(
        sigwinch
    )
