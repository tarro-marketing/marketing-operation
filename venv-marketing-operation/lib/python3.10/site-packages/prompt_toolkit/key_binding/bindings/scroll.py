        ...
        if w.render_info:
            ...
            if w.vertical_scroll < info.content_height - info.window_height:
                if (
                    ...
                    <= info.configured_scroll_offsets.top
                ):
    ...
    if w:
        ...
        if w.render_info:
            ...
            if w.vertical_scroll > 0:
                first_line_height = info.get_height_for_line(
...
def scroll_page_down(event: E) -> None:
    ...
    if w and w.render_info:
        ...
        line_index = max(
            w.render_info.last_visible_line(), w.vertical_scroll + 1
        )
...
def scroll_page_up(event: E) -> None:
    ...
    if w and w.render_info:
        ...
        line_index = max(
            0,
            min(
                w.render_info.first_visible_line(),
