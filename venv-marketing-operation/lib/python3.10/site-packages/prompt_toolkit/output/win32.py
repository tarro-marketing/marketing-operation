...
class Win32Output(Output):
    ...
    def _winapi(self, func: Callable[..., _T], *a: object, **kw: object) -> _T:
        ...
        if _DEBUG_RENDER_OUTPUT:
            ...
            self.LOG.write(
                b"     "
                + ", ".join([f"{i!r}" for i in a]).encode("utf-8")
                + b"\n"
            )
            self.LOG.write(
                b"     "
        ...
        try:
            ...
            if _DEBUG_RENDER_OUTPUT:
                self.LOG.write(
                    (f"    Error in {func.__name__!r} {e!r} {e}\n").encode()
                )
    ...
    def erase_down(self) -> None:
        ...
        length = (size.X - size.X) + size.X * (
            size.Y - sbinfo.dwCursorPosition.Y
        )
    ...
    def set_attributes(self, attrs: Attrs, color_depth: ColorDepth) -> None:
        ...
        self._winapi(
            windll.kernel32.SetConsoleTextAttribute, self.hconsole, win_attrs
        )
    ...
    def _build_color_table() -> list[tuple[int, int, int, int, int]]:
        ...
        return [
            ...
            (
                ...
                0xFF,
                0x44,
                FG.GREEN | FG.INTENSITY,
                BG.GREEN | BG.INTENSITY,
            ),
            ...
            (
                ...
                0x44,
                0xFF,
                FG.MAGENTA | FG.INTENSITY,
                BG.MAGENTA | BG.INTENSITY,
            ),
            (
                0xFF,
                0xFF,
                0x44,
                FG.YELLOW | FG.INTENSITY,
                BG.YELLOW | BG.INTENSITY,
            ),
            (
                0x44,
                0x44,
                0x44,
                FG.BLACK | FG.INTENSITY,
                BG.BLACK | BG.INTENSITY,
            ),
