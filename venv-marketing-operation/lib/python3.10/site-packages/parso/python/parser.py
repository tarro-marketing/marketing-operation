...
class Parser(BaseParser):
    ...
    def __init__(
        ...
        super().__init__(
            pgen_grammar, start_nonterminal, error_recovery=error_recovery
        )
    ...
    def convert_leaf(self, type, value, prefix, start_pos):
        ...
        return self._leaf_map.get(type, tree.Operator)(
    ...
    def error_recovery(self, token):
        ...
        if self._stack_removal(until_index + 1):
            ...
            error_leaf = tree.PythonErrorLeaf(
                typ.name, value, start_pos, prefix
            )
