...
class NFAState:
    ...
    def add_arc(self, next_, nonterminal_or_string=None):
        assert nonterminal_or_string is None or isinstance(
            nonterminal_or_string, str
        )
...
class GrammarParser:
    ...
    def __init__(self, bnf_grammar: str):
        ...
        self.generator = tokenize(
            bnf_grammar, version_info=parse_version_string("3.9")
        )
    ...
    def _expect(self, type_, value=None):
        if self.type != type_:
            self._raise_error(
                "expected %s, got %s [%s]", type_, self.type, self.value
            )
    ...
    def _raise_error(self, msg, *args):
        ...
        raise SyntaxError(
            msg, ("<grammar>", self.begin[0], self.begin[1], line)
        )
