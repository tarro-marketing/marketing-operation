...
def check_sample(
    ...
    if "numpy" in sys.modules and isinstance(
        values, sys.modules["numpy"].ndarray
    ):
        if values.ndim != 1:
...
class Sampler:
    ...
    def __init__(self, weights: Sequence[float], *, observe: bool = True):
        ...
        n = len(weights)
        table: "list[list[int | float | None]]" = [
        ...
        *,
        ...
        forced_choice = (  # pragma: no branch # https://github.com/nedbat/coveragepy/issues/1617
            ...
            if forced is None
                ...
                if forced == base
                or (forced == alternate and alternate_chance > 0)
            )
        )
...
class many:
    ...
    def __init__(
        ...
        *,
        ...
        self.p_continue = _calc_p_continue(
    ...
    def more(self) -> bool:
        ...
        if self.min_size == self.max_size:
            ...
            if self.force_stop:
                ...
                assert (
                    self.forced_size is None or self.count == self.forced_size
                )
                forced_result = False
